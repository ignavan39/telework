...
/*jshint ignore:start*/
(function () {
  function na(k, m) { k.prototype = bb(m.prototype); k.prototype.constructor = k; k.base = m.prototype } function bb(k) { function m() { } m.prototype = k; return new m } function Ua(k, m, v) {
    "millisecond" === v ? k.setMilliseconds(k.getMilliseconds() + 1 * m) : "second" === v ? k.setSeconds(k.getSeconds() + 1 * m) : "minute" === v ? k.setMinutes(k.getMinutes() + 1 * m) : "hour" === v ? k.setHours(k.getHours() + 1 * m) : "day" === v ? k.setDate(k.getDate() + 1 * m) : "week" === v ? k.setDate(k.getDate() + 7 * m) : "month" === v ? k.setMonth(k.getMonth() + 1 * m) : "year" === v && k.setFullYear(k.getFullYear() +
      1 * m); return k
  } function $(k, m) { var v = !1; 0 > k && (v = !0, k *= -1); k = "" + k; for (m = m ? m : 1; k.length < m;)k = "0" + k; return v ? "-" + k : k } function Ea(k) { if (!k) return k; k = k.replace(/^\s\s*/, ""); for (var m = /\s/, v = k.length; m.test(k.charAt(--v));); return k.slice(0, v + 1) } function Aa(k) {
    k.roundRect = function (k, v, s, u, qa, D, y, E) {
      y && (this.fillStyle = y); E && (this.strokeStyle = E); "undefined" === typeof qa && (qa = 5); this.lineWidth = D; this.beginPath(); this.moveTo(k + qa, v); this.lineTo(k + s - qa, v); this.quadraticCurveTo(k + s, v, k + s, v + qa); this.lineTo(k + s,
        v + u - qa); this.quadraticCurveTo(k + s, v + u, k + s - qa, v + u); this.lineTo(k + qa, v + u); this.quadraticCurveTo(k, v + u, k, v + u - qa); this.lineTo(k, v + qa); this.quadraticCurveTo(k, v, k + qa, v); this.closePath(); y && this.fill(); E && 0 < D && this.stroke()
    }
  } function Oa(k, m) { return k - m } function P(k) { var m = ((k & 16711680) >> 16).toString(16), v = ((k & 65280) >> 8).toString(16); k = ((k & 255) >> 0).toString(16); m = 2 > m.length ? "0" + m : m; v = 2 > v.length ? "0" + v : v; k = 2 > k.length ? "0" + k : k; return "#" + m + v + k } function cb(k, m) {
    var v = this.length >>> 0, s = Number(m) || 0, s = 0 > s ? Math.ceil(s) :
      Math.floor(s); for (0 > s && (s += v); s < v; s++)if (s in this && this[s] === k) return s; return -1
  } function s(k) { return null === k || "undefined" === typeof k } function Ba(k) { k.indexOf || (k.indexOf = cb); return k } function db(k) { if (J.fSDec) k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { J._fTWm && J._fTWm(k) }) } function Va(k, m, v) {
    v = v || "normal"; var s = k + "_" + m + "_" + v, u = Wa[s]; if (isNaN(u)) {
      try {
        ...
        k + "; font-size:" + m + "px; font-weight:" + v + ";"; if (!va) { var qa = document.body; va = document.createElement("span"); va.innerHTML = ""; var D = document.createTextNode("Mpgyi"); va.appendChild(D); qa.appendChild(va) } va.style.display = ""; va.setAttribute("style", k); u = Math.round(va.offsetHeight); va.style.display = "none"
      } catch (y) { u = Math.ceil(1.1 * m) } u = Math.max(u, m); Wa[s] = u
    } return u
  } function N(k, m) {
    var v = []; if (v = {
    ...
    }[k || "solid"]) for (var s = 0; s < v.length; s++)v[s] *= m; else v = []; return v
  } function V(k, m, v, u, y) {
    u = u || []; y = s(y) ? eb ? { passive: !1, capture: !1 } : !1 : y; u.push([k, m, v, y]); return k.addEventListener ? (k.addEventListener(m, v, y), v) : k.attachEvent ? (u = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1 }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0 }; v.call(k, m) }, k.attachEvent("on" +
      m, u), u) : !1
  } function fb(k) {
    if (k._menuButton) k.exportEnabled ? Ja(k._menuButton) : ta(k._menuButton); else if (k.exportEnabled && u) {
      var m = !1; k._menuButton = document.createElement("button"); ua(k, k._menuButton, "menu"); k._toolBar.appendChild(k._menuButton); V(k._menuButton, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); V(k._menuButton, "click", function () {
      ...
      m = !1; k._dropdownMenu = document.createElement("div"); k._dropdownMenu.setAttribute("tabindex", -1); var v = -1 !== k.theme.indexOf("dark") ? "black" : "#888888"; k._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
        k.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " + v; k._dropdownMenu.style.display = "none"; k._toolBar.appendChild(k._dropdownMenu); V(k._dropdownMenu, "blur", function () { ta(k._dropdownMenu); k._dropDownCloseTime = new Date }, k.allDOMEventHandlers, !0); v = document.createElement("div"); v.style.cssText = "padding: 12px 8px 12px 8px"; v.innerHTML = k._cultureInfo.printText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); V(v, "touchstart", function (k) {
          ...
          k._cultureInfo.saveJPGText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); V(v, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); V(v, "mouseover", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0); V(v, "mouseout", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers,
            !0); V(v, "click", function () { k.exportChart({ format: "jpeg", fileName: k.exportFileName }); ta(k._dropdownMenu) }, k.allDOMEventHandlers, !0); v = document.createElement("div"); v.style.cssText = "padding: 12px 8px 12px 8px"; v.innerHTML = k._cultureInfo.savePNGText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); V(v, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); V(v, "mouseover", function () {
              m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover,
                this.style.color = k.toolbar.fontColorOnHover)
            }, k.allDOMEventHandlers, !0); V(v, "mouseout", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0); V(v, "click", function () { k.exportChart({ format: "png", fileName: k.exportFileName }); ta(k._dropdownMenu) }, k.allDOMEventHandlers, !0)
    }
  } function Xa(k, m, v) {
    k *= ga; m *= ga; k = v.getImageData(k, m, 2, 2).data; m = !0; for (v = 0; 4 > v; v++)if (k[v] !== k[v + 4] | k[v] !== k[v + 8] | k[v] !== k[v + 12]) { m = !1; break } return m ? k[0] <<
      16 | k[1] << 8 | k[2] : 0
  } function la(k, m, v) { return k in m ? m[k] : v[k] } function Ka(k, m, v) { if (u && Ya) { var s = k.getContext("2d"); La = s.webkitBackingStorePixelRatio || s.mozBackingStorePixelRatio || s.msBackingStorePixelRatio || s.oBackingStorePixelRatio || s.backingStorePixelRatio || 1; ga = Pa / La; k.width = m * ga; k.height = v * ga; Pa !== La && (k.style.width = m + "px", k.style.height = v + "px", s.scale(ga, ga)) } else k.width = m, k.height = v } function gb(k) {
    if (!hb) {
      var m = !1, v = !1; "undefined" === typeof pa.Chart.creditHref ? (k.creditHref = Y("iuuqr;..b`ow`rkr/bnl."),
        k.creditText = Y("B`ow`rKR/bnl")) : (m = k.updateOption("creditText"), v = k.updateOption("creditHref")); if (k.creditHref && k.creditText) {
    ...
    var v = document.createElement("canvas"); v.setAttribute("class", "canvasjs-chart-canvas"); Ka(v, k, m); u || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(v); return v
  } function oa(k, m) { for (var v in m) k.style[v] = m[v] } function ua(k, m, v) {
    m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", oa(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" })); m.getAttribute("state") !==
  ...
  } function Ja() { for (var k = null, m = 0; m < arguments.length; m++)k = arguments[m], k.style && (k.style.display = "inline") } function ta() {
    for (var k =
      null, m = 0; m < arguments.length; m++)(k = arguments[m]) && k.style && (k.style.display = "none")
  } function Qa(k, m, v, s, u) { if (null === k || "undefined" === typeof k) return "undefined" === typeof v ? m : v; k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof s && (k = Math.min(s, k), "undefined" !== typeof u && (k = Math.max(u, k))); return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof v ? m : v } function W(k, m, v, u, y) {
    ...
    "undefined" ===
    typeof u && (u = 0); this._padding = u; this._x1 = k; this._y1 = m; this._x2 = v; this._y2 = s; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding
  } function ia(k, m) { ia.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = k; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Ra(k, m) { Ra.base.constructor.call(this, "Toolbar", "toolbar", m, null, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar" } function xa(k, m) {
  ...
  } function Ga(k, m, v) { Ga.base.constructor.call(this, "Subtitle", "subtitles", m, v, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0; "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null; this.bounds = { x1: null, y1: null, x2: null, y2: null } } function Sa() {
    this.pool =
    []
  } function Ha(k) { var m; k && Ia[k] && (m = Ia[k]); Ha.base.constructor.call(this, "CultureInfo", null, m, null, null) } var Fa = !1, J = {}, u = !!document.createElement("canvas").getContext, pa = {
    Chart: {
  ...
  }, Ia = { en: {} }, y = u ? "Trebuchet MS, Helvetica, sans-serif" :
  ...
  ha = da = "#000000"; var U = 20, E = 14, Ta = {
    colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Da, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Da, fontSize: E, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: aa, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
      titleFontFamily: y, titleFontSize: U, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: y,
      ...
      titleFontFamily: y, titleFontSize: U, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: y, labelFontSize: E, labelFontColor: T, labelFontWeight: "normal", lineThickness: 1, lineColor: I, tickThickness: 1, tickColor: I, gridThickness: 0, gridColor: I, stripLines: [{ labelFontFamily: y, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        labelFontFamily: y, labelFontSize: E, labelFontColor: "#EEEEEE",
      ...
      fontFamily: y,
      fontSize: 14, fontColor: aa, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center"
    }, toolTip: { fontFamily: y, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }
  }; T = aa = "#F5F5F5"; I = "#FFFFFF"; da = "#40BAF1"; ha = "#F5F5F5"; var U = 20, E = 14, Za = {
  ...
  }; T = aa = "#F5F5F5"; I = "#FFFFFF"; da = "#40BAF1"; ha = "#F5F5F5"; U = 20; E = 14; Da = {
    colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Da, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Da, fontSize: E, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
    ...
    }, data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: T, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
      ...
      titleFontFamily: y, titleFontSize: U, titleFontColor: T, titleFontWeight: "normal", labelFontFamily: y, labelFontSize: E, labelFontColor: T, labelFontWeight: "normal", lineThickness: 1, lineColor: I, tickThickness: 1,
  ...
  I = "#FFFFFF"; T = aa = "#FAFAFA"; da = "#40BAF1"; ha = "#F5F5F5"; var U = 20, E = 14, $a = {
    light1: Ta, light2: Za, dark1: Da, dark2: {
      ...
      data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: T, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
        ...
        titleFontFamily: y, titleFontSize: U, titleFontColor: T,
    ...
    theme2: Za, theme3: Ta
  }, Q = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") }; (function () {
    J.fSDec = function (k) { for (var m = "", v = 0; v < k.length; v++)m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v)); return m }; J.obj = {
  ...
  var eb = function () { var k = !1; try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { k = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (v) { k = !1 } return k }(), Wa = {}, va = null, jb = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) }, kb = function (k, m, v) {
    ...
    D = /[^-+\dA-Z]/g; return function (E, N, M) {
      var I = M ? M.days : m, P = M ? M.months : s, V = M ? M.shortDays : v, Q = M ? M.shortMonths : u; M = ""; var J = !1; E = E && E.getTime ? E : E ? new Date(E) : new Date; if (isNaN(E)) throw SyntaxError("invalid date"); "UTC:" === N.slice(0, 4) && (N = N.slice(4), J = !0); M = J ? "getUTC" : "get"; var W = E[M + "Date"](), L = E[M + "Day"](), X = E[M + "Month"](), a = E[M + "FullYear"](), d = E[M + "Hours"](), c = E[M + "Minutes"](), b = E[M + "Seconds"](), e = E[M + "Milliseconds"](), f = J ? 0 : E.getTimezoneOffset(); return M = N.replace(k, function (p) {
        switch (p) {
          case "D": return W;
    ...
    if (null === k) return ""; if (!isFinite(k)) return k; k = Number(k); var s = 0 > k ? !0 : !1; s && (k *= -1); var u = v ? v.decimalSeparator : ".", y = v ? v.digitGroupSeparator : ",", D = ""; m = String(m); var D = 1, E = v = "", N = -1, M = [], I = [], P = 0, J = 0, V = 0, Q = !1, W = 0, E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); m = null; for (var L = 0; E && L < E.length; L++)if (m = E[L], "." === m && 0 > N) N = L; else {
      ...
      var X =
        D, D = []; if ("0" === m) for (m = P - J - (X ? X.length : 0); 0 < m;)X.unshift("0"), m--; for (; 0 < X.length;)v = X.pop() + v, Q++, 0 === Q % E && (L === V && 0 < X.length) && (v = y + v)
    } else 0 < D.length ? (v = D.pop() + v, J++, Q++) : "0" === m && (v = "0" + v, J++, Q++), 0 === Q % E && (L === V && 0 < D.length) && (v = y + v); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, E = Q, Q = 0, 0 < D.length && (v = y + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > W ? m.replace("+", "").replace("-",
    ...
    v += (M ? u : "") + y; return s ? "-" + v : v
  }, Ma = function (k) { var m = 0, v = 0; k = k || window.event; k.offsetX || 0 === k.offsetX ? (m = k.offsetX, v = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, v = k.layerY) : (m = k.pageX - k.target.offsetLeft, v = k.pageY - k.target.offsetTop); return { x: m, y: v } }, Ya = !0, Pa = window.devicePixelRatio || 1, La = 1, ga = Ya ? Pa / La : 1, ca = function (k, m, v, s, u, y, D, E, N, M, Q, P, I) {
    "undefined" === typeof I && (I = 1); D = D || 0; E = E || "black"; var J = 15 < s - m && 15 < u - v ? 8 : 0.35 * Math.min(s - m, u - v); k.beginPath(); k.moveTo(m, v); k.save(); k.fillStyle = y; k.globalAlpha =
  ...
  }, Y = function (k) { for (var m = "", v = 0; v < k.length; v++)m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v)); return m }, ab = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !==
    window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))), hb = ab && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")), ib = {
  ...
  W.prototype.setOptions = function (k, m) { if (pa[this._defaultsKey]) { var v = pa[this._defaultsKey], s; for (s in v) "publicProperties" !== s && v.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : v[s]) } else Fa && window.console && console.log("defaults not set") }; W.prototype.get = function (k) {
    var m = pa[this._defaultsKey]; if ("options" === k) return this.options && this.options._isPlaceholder ? null : this.options; if (m.hasOwnProperty(k) || m.publicProperties && m.publicProperties.hasOwnProperty(k)) return this[k]; window.console &&
      window.console.log('Property "' + k + "\" doesn't exist. Please check for typo.")
  }; W.prototype.set = function (k, m, s) {
    s = "undefined" === typeof s ? !0 : s; var u = pa[this._defaultsKey]; if ("options" === k) this.createUserOptions(m); else if (u.hasOwnProperty(k) || u.publicProperties && u.publicProperties.hasOwnProperty(k) && "readWrite" === u.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(), this.options[k] = m; else {
    ...
    u = "undefined" === typeof u ? !0 : u; var y = pa[this._defaultsKey]; y.hasOwnProperty(k) || y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readWrite" === y.publicProperties[k] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[k] && (this.options[k] =
  ...
  }; W.prototype.remove = function (k) { k = "undefined" === typeof k ? !0 : k; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName]; Ba(m); var s = m.indexOf(this.options); 0 <= s && m.splice(s, 1) } else delete this.parent.options[this.optionsName]; k && (this.stockChart || this.chart || this).render() }; W.prototype.updateOption = function (k) {
    !pa[this._defaultsKey] && (Fa && window.console) && console.log("defaults not set"); var m = pa[this._defaultsKey], u = {}, y = this[k], E = this._themeOptionsKey,
    ...
    function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ca.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; na(ia, W); ia.prototype._initialize = function () {
      ...
      if (0 !== this.fontSize) {
        k && this.ctx.save(); var m = this.ctx.font; this.ctx.textBaseline = this.textBaseline; var s = 0; this._isDirty &&
          this.measureText(this.ctx); this.ctx.translate(this.x, this.y + s); "middle" === this.textBaseline && (s = -this._lineHeight / 2); this.ctx.font = this._getFontString(); this.ctx.rotate(Math.PI / 180 * this.angle); var u = 0, y = this.topPadding, E = null; this.ctx.roundRect || Aa(this.ctx); (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, s, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); this.ctx.fillStyle = this.fontColor; for (s = 0; s < this._wrappedText.lines.length; s++) {
            E =
            this._wrappedText.lines[s]; if ("right" === this.horizontalAlign || "right" === this.textAlign) u = this.width - E.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) u = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding; this.ctx.fillText(E.text, u, y); y += E.height
          } this.ctx.font = m; k && this.ctx.restore()
      }
    }; ia.prototype.setText = function (k) {
      this.text = k; this._isDirty = !0; this._wrappedText =
        null
    }; ia.prototype.measureText = function () { this._lineHeight = Va(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock"; this._wrapText(this.ctx); this._isDirty = !1; return { width: this.width, height: this.height } }; ia.prototype._getLineWithWidth = function (k, m, s) {
      k = String(k); if (!k) return { text: "", width: 0 }; var u = s = 0, y = k.length - 1, E = Infinity; for (this.ctx.font = this._getFontString(); u <= y;) {
        var E = Math.floor((u + y) / 2), D = k.substr(0, E + 1); s = this.ctx.measureText(D).width;
        if (s < m) u = E + 1; else if (s > m) y = E - 1; else break
      } s > m && 1 < D.length && (D = D.substr(0, D.length - 1), s = this.ctx.measureText(D).width); m = !0; if (D.length === k.length || " " === k[D.length]) m = !1; m && (k = D.split(" "), 1 < k.length && k.pop(), D = k.join(" "), s = this.ctx.measureText(D).width); return { text: D, width: s }
    }; ia.prototype._wrapText = function () {
      var k = new String(Ea(String(this.text))), m = [], s = this.ctx.font, u = 0, y = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) y = u = 0; else for (; 0 < k.length;) {
        var E = this.maxHeight - (this.topPadding +
          this.bottomPadding), D = this._getLineWithWidth(k, this.maxWidth - (this.leftPadding + this.rightPadding), !1); D.height = this._lineHeight; m.push(D); var J = y, y = Math.max(y, D.width), u = u + D.height, k = Ea(k.slice(D.text.length, k.length)); E && u > E && (D = m.pop(), u -= D.height, y = J)
      ...
      var k; k = "" + (this.fontStyle ? this.fontStyle + " " :
        ""); k += this.fontWeight ? this.fontWeight + " " : ""; k += this.fontSize ? this.fontSize + "px " : ""; var m = this.fontFamily ? this.fontFamily + "" : ""; !u && m && (m = m.split(",")[0], "'" !== m[0] && '"' !== m[0] && (m = "'" + m + "'")); return k += m
    }; na(Ra, W); na(xa, W); xa.prototype.setLayout = function () {
      if (this.text) {
        var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = k.layoutManager.getFreeSpace(), u = m.x1, y = m.y1, E = 0, J = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, I; "top" === this.verticalAlign ||
          "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), J = 0.5 * m.height - this.margin - 2, E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), J = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), J = 0.5 * m.height - 4)); var M; s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !==
            typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : M = 2 * this.padding; this.wrap || (J = Math.min(J, 1.5 * this.fontSize + M)); J = new ia(this.ctx, {
              ...
              this.width = M.width, this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (u = m.x1 + 2, y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2), E = -90, I = "left", this.width = M.height, this.height = M.width) : "right" === this.horizontalAlign ? (u = m.x2 - 2, y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2), E = 90, I = "right", this.width = M.height, this.height = M.width) : "center" === this.horizontalAlign && (y = k.y1 + (k.height / 2 - M.height / 2), u = k.x1 + (k.width / 2 - M.width / 2), I = "center", this.width = M.width, this.height = M.height), N = "center"); J.x =
                u; J.y = y; J.angle = E; J.horizontalAlign = N; this._textBlock = J; k.layoutManager.registerSpace(I, { width: this.width + ("left" === I || "right" === I ? this.margin + 2 : 0), height: this.height + ("top" === I || "bottom" === I ? this.margin + 2 : 0) }); this.bounds = { x1: u, y1: y, x2: u + this.width, y2: y + this.height }; this.ctx.textBaseline = "top"
      }
    }; xa.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; na(Ga, W); Ga.prototype.setLayout = xa.prototype.setLayout; Ga.prototype.render = xa.prototype.render; Sa.prototype.get = function (k, m) {
      var s =
        null; 0 < this.pool.length ? (s = this.pool.pop(), Ka(s, k, m)) : s = sa(k, m); return s
    }; Sa.prototype.release = function (k) { this.pool.push(k) }; na(Ha, W); var Na = { addTheme: function (k, m) { $a[k] = m }, addColorSet: function (k, m) { ya[k] = m }, addCultureInfo: function (k, m) { Ia[k] = m }, formatNumber: function (k, m, s) { s = s || "en"; if (Ia[s]) return ea(k, m || "#,##0.##", new Ha(s)); throw "Unknown Culture Name"; }, formatDate: function (k, m, s) { s = s || "en"; if (Ia[s]) return za(k, m || "DD MMM YYYY", new Ha(s)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
      "undefined" !== typeof module.exports ? module.exports = Na : "function" === typeof define && define.amd ? define([], function () { return Na }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Na); y = Na.Chart = function () {
        function k(a, d) { return a.x - d.x } function m(a, d, c) {
          d = d || {}; s(c) ? (this.predefinedThemes = $a, this.optionsName =
          ...
          for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
            var f, p, l; l = e - 1; f = 0 === l ? 0 : l - 1; p = l === a.length - 1 ? l : l + 1; b = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[l].x ? 0.01 : a[p].x - a[l].x)) * (d - 1) /
              2 + 1; var A = (a[p].x - a[f].x) / b; b = (a[p].y - a[f].y) / b; c[c.length] = a[l].x > a[f].x && 0 < A || a[l].x < a[f].x && 0 > A ? { x: a[l].x + A / 3, y: a[l].y + b / 3 } : { x: a[l].x, y: a[l].y + b / 9 }; l = e; f = 0 === l ? 0 : l - 1; p = l === a.length - 1 ? l : l + 1; b = Math.abs((a[p].x - a[f].x) / (0 === a[l].x - a[f].x ? 0.01 : a[l].x - a[f].x)) * (d - 1) / 2 + 1; A = (a[p].x - a[f].x) / b; b = (a[p].y - a[f].y) / b; c[c.length] = a[l].x > a[f].x && 0 < A || a[l].x < a[f].x && 0 > A ? { x: a[l].x - A / 3, y: a[l].y - b / 3 } : { x: a[l].x, y: a[l].y - b / 9 }; c[c.length] = a[e]
          } return c
        } function y(a, d, c, b, e, f, p, l, A, h) {
          var n = 0; h ? (p.color = f, l.color = f) :
          ...
          this.ctx = this.chart.ctx; this.ghostCtx = this.chart._eventManager.ghostCtx; this.items = []; this.optionsName = "legend"; this.height = this.width = 0; this.orientation = null; this.dataSeries = []; this.bounds = { x1: null, y1: null, x2: null, y2: null }; "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.lineHeight = Va(this.fontFamily, this.fontSize, this.fontWeight); this.horizontalSpacing = this.fontSize
        } function I(a, d, c, b) {
        ...
        } function aa(a, d, c) { aa.base.constructor.call(this, "Crosshair", "crosshair", d, null, c); this.chart = a; this.ctx = this.chart.ctx; this.axis = c; this.optionsName = "crosshair"; this._thicknessType = "pixel" } function $(a, d) {
        ...
        } na(m, W); m.prototype.destroy = function () {
          ...
          var a =
            this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this._selectedColorSet = "undefined" !== typeof ya[this.colorSet] ? ya[this.colorSet] : ya.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo =
              new Ha(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && u; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                  ...
                  this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor; V(this._zoomButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers); V(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ua(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ua(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); V(this._zoomButton, "mouseover", function () {
                  ...
                  }, this.allDOMEventHandlers); V(this._zoomButton, "mouseout", function () { d || (oa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && oa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) },
                ...
                }, this.allDOMEventHandlers), this.overlaidCanvas.style.cursor = a._defaultCursor); this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), Ja(a._zoomButton, a._resetButton)) :
                  (this.zoomEnabled = !0, this.panEnabled = !1))
              } else this.panEnabled = this.zoomEnabled = !1; fb(this); "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? ua(a, a._zoomButton, "zoom") : ua(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && ua(a, a._resetButton, "reset")); this.options.toolTip && this.toolTip.options !== this.options.toolTip && (this.toolTip.options = this.options.toolTip); for (var c in this.toolTip.options) this.toolTip.options.hasOwnProperty(c) && this.toolTip.updateOption(c)
        };
        m.prototype._updateSize = function () {
          var a; a = [this.canvas, this.overlaidCanvas, this._eventManager.ghostCanvas]; var d = 0, c = 0; this.options.width ? d = this.width : this.width = d = 0 < this.container.clientWidth ? this.container.clientWidth : this.width; this.options.height ? c = this.height : this.height = c = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; if (this.canvas.width !== d * ga || this.canvas.height !== c * ga) {
            for (var b = 0; b < a.length; b++)Ka(a[b], d, c); this.bounds = {
              x1: 0, y1: 0, x2: this.width, y2: this.height, width: this.width,
              height: this.height
            }; a = !0
          } else a = !1; return a
        }; m.prototype._initialize = function () {
          this.isNavigator = s(this.parent) || s(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0; this.toolbar = new Ra(this, this.options.toolbar); this._animator ? this._animator.cancelAllAnimations() : this._animator = new ha(this); this.removeAllEventListeners(); this.disableToolTip = !1; this._axes = []; this.funnelPyramidClickHandler = this.pieDoughnutClickHandler = null; this._updateOptions(); this.animatedRender = u && this.animationEnabled &&
            0 === this.renderCount; this._updateSize(); this.clearCanvas(); this.ctx.beginPath(); this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Ca(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; var a = 0, d = null; if (this.options.data) {
              for (var c = 0; c <
                this.options.data.length; c++)if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                  var b = new I(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId); "error" === b.type && (b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) &&
        ...
        m.prototype.setLayout = function () {
          ...
          var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea || this.legend.render(); if ("normal" ===
            this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) D.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = sa(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } gb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit = 3; u && this._breaksCanvas &&
              (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                var l = f.plotUnits[p], A = null; l.targetCanvas =
                ...
                for (var h = 0; h < l.dataSeriesIndexes.length; h++)this._dataInRenderedOrder.push(this.data[l.dataSeriesIndexes[h]]); this.animatedRender && (l.targetCanvasCtx.miterLimit = e, A && c.push(A))
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            var l = this.data[a.dataSeriesIndexes[p]], A = 0, h = !1, n = !1, r; if ("normal" === l.axisPlacement ||
              "xySwapped" === l.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
                this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (l.dataPoints[A].x && l.dataPoints[A].x.getTime || "dateTime" === l.xValueType) f = !0; for (A = 0; A < l.dataPoints.length; A++) {
                  "undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)); l.dataPoints[A].x.getTime ? (f = !0, b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x; e = l.dataPoints[A].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e); e > d.max && "number" === typeof e && (d.max = e); if (0 < A) {
                    if (a.axisX.logarithmic) {
                      var w =
                        b / l.dataPoints[A - 1].x; 1 > w && (w = 1 / w); c.minDiff > w && 1 !== w && (c.minDiff = w)
                    } else w = b - l.dataPoints[A - 1].x, 0 > w && (w *= -1), c.minDiff > w && 0 !== w && (c.minDiff = w); null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (w = e / l.dataPoints[A - 1].y, 1 > w && (w = 1 / w), d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = e - l.dataPoints[A - 1].y, 0 > w && (w *= -1), d.minDiff > w && 0 !== w && (d.minDiff = w)))
                  } if (b < q && !h) null !== e && (r = b); else {
                    if (!h && (h = !0, 0 < A)) { A -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; l.dataPoints[A].label && (a.axisX.labels[b] = l.dataPoints[A].label);
                ...
                this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, w = !1, k; if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                  this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (r.dataPoints[q].x && r.dataPoints[q].x.getTime || "dateTime" === r.xValueType) f = !0; for (q = 0; q < r.dataPoints.length; q++) {
                    "undefined" === typeof r.dataPoints[q].x && (r.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); r.dataPoints[q].x.getTime ? (f = !0, b = r.dataPoints[q].x.getTime()) : b = r.dataPoints[q].x; e = s(r.dataPoints[q].y) ? 0 : r.dataPoints[q].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < q) {
                      ...
                      if (!g && (g = !0, 0 < q)) { q -= 2; continue } if (b > t && !w) w = !0; else if (b > t && w) continue; r.dataPoints[q].label && (a.axisX.labels[b] =
                        r.dataPoints[q].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === r.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? p[b] ? p[b] += e : (p[b] = e, A = Math.min(e, A)) : l[b] ? l[b] += e : (l[b] = e, h = Math.max(e, h)))
                    }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, l = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
              var n = this.data[a.dataSeriesIndexes[h]], r = 0, q = !1, g = !1, w; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, m = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[r].x && n.dataPoints[r].x.getTime || "dateTime" === n.xValueType) f = !0; for (r =
                  0; r < n.dataPoints.length; r++) {
                    ...
                    } if (b < k && !q) null !== e && (w = b); else {
                      if (!q && (q = !0, 0 < r)) { r -= 2; continue } if (b > m && !g) g = !0; else if (b > m && g) continue; n.dataPoints[r].label && (a.axisX.labels[b] = n.dataPoints[r].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && w < b && (c.viewPortMin = w) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] :
              ...
              -99 : Math.min(d.viewPortMin, -99)) : !p && l && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)); d.viewPortMin = d.min; d.viewPortMax = d.max; a.dataPointYSums = A
          }
        }; m.prototype._processMultiYPlotUnit = function (a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
            var h = this.data[a.dataSeriesIndexes[A]], n = 0, r = !1, q = !1, g, w, k; if ("normal" === h.axisPlacement ||
              "xySwapped" === h.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
                this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (h.dataPoints[n].x && h.dataPoints[n].x.getTime || "dateTime" === h.xValueType) l = !0; for (n = 0; n < h.dataPoints.length; n++) {
                  "undefined" === typeof h.dataPoints[n].x && (h.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); h.dataPoints[n].x.getTime ? (l = !0, b = h.dataPoints[n].x.getTime()) : b = h.dataPoints[n].x; if ((e = h.dataPoints[n].y) && e.length) {
                    f = Math.min.apply(null, e); p = Math.max.apply(null, e); w = !0; for (var x = 0; x < e.length; x++)null === e.k && (w = !1); w && (r || (k = g), g =
                      b)
                  } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); p > d.max && (d.max = p); 0 < n && (a.axisX.logarithmic ? (w = b / h.dataPoints[n - 1].x, 1 > w && (w = 1 / w), c.minDiff > w && 1 !== w && (c.minDiff = w)) : (w = b - h.dataPoints[n - 1].x, 0 > w && (w *= -1), c.minDiff > w && 0 !== w && (c.minDiff = w)), e && (null !== e[0] && h.dataPoints[n - 1].y && null !== h.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (w = e[0] / h.dataPoints[n - 1].y[0], 1 > w && (w = 1 / w), d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = e[0] - h.dataPoints[n - 1].y[0], 0 > w && (w *= -1), d.minDiff > w && 0 !== w && (d.minDiff = w))));
          ...
          function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
              var l = this.data[a.dataSeriesIndexes[p]], A = 0, h = !1, n = !1, r = b = 0; if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX &&
                    ...
                    b = 0) : (e = "number" !== typeof l.dataPoints[A].y ? 0 : l.dataPoints[A].y, l.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum, l.dataPointEOs[A].cumulativeSum = 0 === A ? e : l.dataPointEOs[A - 1].cumulativeSum + e, b += e); for (A = 0; A < l.dataPoints.length; A++)if ("undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), l.dataPoints[A].x.getTime ? (f = !0, b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x, e = l.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), l.dataPointEOs[A].cumulativeSum <
                      d.min && (d.min = l.dataPointEOs[A].cumulativeSum), l.dataPointEOs[A].cumulativeSum > d.max && (d.max = l.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (r = b / l.dataPoints[A - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - l.dataPoints[A - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = l.dataPointEOs[A].cumulativeSum / l.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = l.dataPointEOs[A].cumulativeSum -
                        l.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
                          if (!h && (h = !0, 0 < A)) { A -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; l.dataPoints[A].label && (a.axisX.labels[b] = l.dataPoints[A].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); 0 < A && (l.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[A - 1].cumulativeSum), l.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[A - 1].cumulativeSum));
                      l.dataPointEOs[A].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[A].cumulativeSum); l.dataPointEOs[A].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[A].cumulativeSum)
                    } l.axisX.valueType = l.xValueType = f ? "dateTime" : "number"
            }
            ...
            function a(a, b, c, e) {
              ...
              for (p = 0; p < this.plotInfo.plotTypes.length; p++)for (f = this.plotInfo.plotTypes[p], l = 0; l < f.plotUnits.length; l++)b = f.plotUnits[l], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" ===
                b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (p = 0; p < this._axes.length; p++)if (this._axes[p].dataInfo._dataRanges) {
                  var A = this._axes[p].dataInfo.min; b = (this._axes[p].dataInfo.max + 1 - A) * Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var h = this._axes[p].dataInfo._dataRanges, n, r, f = []; if (this._axes[p].dataInfo.dataPointYPositiveSums) {
                    var q = this._axes[p].dataInfo.dataPointYPositiveSums;
                    n = h; for (l in q) if (q.hasOwnProperty(l) && !isNaN(l) && (r = q[l], !s(r))) { var g = Math.floor((r - A) / b); r < n[g].min && (n[g].min = r); r > n[g].max && (n[g].max = r) } delete this._axes[p].dataInfo.dataPointYPositiveSums
                  } if (this._axes[p].dataInfo.dataPointYNegativeSums) { q = this._axes[p].dataInfo.dataPointYNegativeSums; n = h; for (l in q) q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l], s(r) || (g = Math.floor((r - A) / b), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r))); delete this._axes[p].dataInfo.dataPointYNegativeSums } for (l = 0; l < h.length -
            ...
            var b = null; if (c = this.getDataPointAtXY(a,
              d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u) b = Xa(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) { var e = this.legend.items[c]; a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id) } return b
          }; m.prototype.getAutoFontSize = kb; m.prototype.resetOverlayedCanvas = function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) }; m.prototype.clearCanvas = jb; m.prototype.attachEvent = function (a) { this._events.push(a) }; m.prototype._touchEventHandler = function (a) {
            if (a.changedTouches &&
              this.interactivityEnabled) {
                var d = [], c = a.changedTouches, b = c ? c[0] : a, e = null; switch (a.type) {
                  case "touchstart": case "MSPointerDown": d = ["mousemove", "mousedown"]; this._lastTouchData = Ma(b); this._lastTouchData.time = new Date; break; case "touchmove": case "MSPointerMove": d = ["mousemove"]; break; case "touchend": case "MSPointerUp": var f = this._lastTouchData && this._lastTouchData.time ? new Date - this._lastTouchData.time : 0, d = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType || 300 > f ? ["mouseup",
                    "click"] : ["mouseup"]; break; default: return
                }if (!(c && 1 < c.length)) {
                  e = Ma(b); e.time = new Date; try { var p = e.y - this._lastTouchData.y, f = e.time - this._lastTouchData.time; if (1 < Math.abs(p) && this._lastTouchData.scroll || 5 < Math.abs(p) && 250 > f) this._lastTouchData.scroll = !0 } catch (l) { } this._lastTouchEventType = a.type; if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (c = 0; c < d.length; c++)if (e = d[c], p = document.createEvent("MouseEvent"), p.initMouseEvent(e, !0, !0, window,
            ...
            a.srcElement && (a.target = a.srcElement); var d = Ma(a), c = a.type, b, e; a.which ? e = 3 == a.which : a.button && (e = 2 == a.button); m.capturedEventParam && (b = m.capturedEventParam, "mouseup" === c && (m.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)), b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && u || b[c].call(b.context, d.x, d.y) :
              a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1))); if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Fa && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
              ...
              this.resetOverlayedCanvas(); if (this.axisX && 0 < this.axisX.length) for (p = 0; p < this.axisX.length; p++)this.axisX[p].crosshair && this.axisX[p].crosshair.enabled && this.axisX[p].renderCrosshair(a, d); if (this.axisX2 && 0 < this.axisX2.length) for (p =
                0; p < this.axisX2.length; p++)this.axisX2[p].crosshair && this.axisX2[p].crosshair.enabled && this.axisX2[p].renderCrosshair(a, d); if (this.axisY && 0 < this.axisY.length) for (p = 0; p < this.axisY.length; p++)this.axisY[p].crosshair && this.axisY[p].crosshair.enabled && this.axisY[p].renderCrosshair(a, d); if (this.axisY2 && 0 < this.axisY2.length) for (p = 0; p < this.axisY2.length; p++)this.axisY2[p].crosshair && this.axisY2[p].crosshair.enabled && this.axisY2[p].renderCrosshair(a, d)
            }
                ...
                var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), p = this; "xySwapped" === this.plotInfo.axisPlacement && (c = f, f = e, e = c); c = this.dragStartPoint.x - a; b = this.dragStartPoint.y - d; 2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled) ? (this.toolTip.hide(), this.toolTip.dispatchEvent("hidden", { chart: this, toolTip: this.toolTip }, this.toolTip)) : this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, d); if ((!e || 2 < Math.abs(c) ||
                  !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2 }, clearTimeout(p._panTimerId), p._panTimerId = setTimeout(function (b, c, e, f) {
                    ...
                    c = this.overlaidCanvasCtx.globalAlpha; this.overlaidCanvasCtx.fillStyle = "#A89896"; var b = e ? this.dragStartPoint.x : this.plotArea.x1, l = f ? this.dragStartPoint.y : this.plotArea.y1, A = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, h = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1; this.validateRegion(b, l, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5"); this.overlaidCanvasCtx.globalAlpha =
                      0.7; this.overlaidCanvasCtx.fillRect(b, l, A, h); this.overlaidCanvasCtx.globalAlpha = c
                  }
            ...
            e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), l = !1, A = [], h = [], n = [], r = 0; r < this._axes.length; r++)("axisX" === this._axes[r].type && f || "axisY" === this._axes[r].type &&
              p) && h.push(this._axes[r]); for (p = 0; p < h.length; p++) {
                var r = h[p], f = !1, q = r.convertPixelToValue({ x: a, y: d }), g = r.convertPixelToValue({ x: c, y: b }); if (q > g) var w = g, g = q, q = w; if (r.scaleBreaks) for (w = 0; !f && w < r.scaleBreaks._appliedBreaks.length; w++)f = r.scaleBreaks._appliedBreaks[w].startValue <= q && r.scaleBreaks._appliedBreaks[w].endValue >= g; if (isFinite(r.dataInfo.minDiff)) if (w = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && w < Math.pow(r.dataInfo.minDiff,
                  3) || !r.logarithmic && w < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum)) A.push(r), n.push({ val1: q, val2: g }), l = !0; else if (!e) { l = !1; break }
            ...
            } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Ca(a.x1, a.y1, a.x2, a.y2, 2)
          }; m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, p = 0, l = b = p = e = f = 0, A = 0; for (a = 0; a < this._indexLabels.length; a++) {
              var h =
                    ...
                    h.dataPoint); if (h.dataSeries.indexLabelFormatter || h.dataPoint.indexLabelFormatter) x = { chart: this, dataSeries: h.dataSeries, dataPoint: h.dataPoint, index: h.indexKeyword, total: t.total, percent: t.percent }; var z = h.dataPoint.indexLabelFormatter ? h.dataPoint.indexLabelFormatter(x) : h.dataPoint.indexLabel ? this.replaceKeywordsWithValue(h.dataPoint.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword) : h.dataSeries.indexLabelFormatter ? h.dataSeries.indexLabelFormatter(x) : h.dataSeries.indexLabel ? this.replaceKeywordsWithValue(h.dataSeries.indexLabel,
                      h.dataPoint, h.dataSeries, null, h.indexKeyword) : null; if (null !== z && "" !== z) {
                        var t = la("indexLabelPlacement", h.dataPoint, h.dataSeries), x = la("indexLabelOrientation", h.dataPoint, h.dataSeries), F = h.direction, B = h.dataSeries.axisX, C = h.dataSeries.axisY, v = !1, g = new ia(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: f ? 5 * A : 1.5 * A, angle: "horizontal" === x ? 0 : -90, text: z, padding: 0, backgroundColor: g, horizontalAlign: "left", fontSize: A, fontFamily: r, fontWeight: p, fontColor: l, fontStyle: q, textBaseline: "top" }); g.measureText(); h.dataSeries.indexLabelMaxWidth =
                          ...
                          } else if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum) continue; e = p = 2; "horizontal" === x ? (l = g.width, A = g.height) : (A = g.width, l = g.height); if ("normal" === this.plotInfo.axisPlacement) {
                            if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) t = "auto", p = 4; else if (0 <= n.indexOf("stacked")) "auto" === t && (t = "inside"); else if ("bubble" === n || "scatter" === n) t = "inside"; r = h.point.x -
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b =
                this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var A = a.dataSeriesIndexes[l], h = this.data[A]; c.lineWidth = h.lineThickness; var n = h.dataPoints, r = "solid"; if (c.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness), r = h.lineDashType, g = N(r, h.lineThickness); c.setLineDash(g) } var w = h.id; this._eventManager.objectMap[w] = { objectType: "dataSeries", dataSeriesIndex: A }; w = P(w); b.strokeStyle = w;
                  b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var w = h._colorSet, k = w = h.lineColor = h.options.lineColor ? h.options.lineColor : w[0]; c.strokeStyle = w; var m = !0, t = 0, x, s; c.beginPath(); if (0 < n.length) {
                    for (var F = !1, t = 0; t < n.length; t++)if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F))) if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || F || m) && (c.stroke(), u && b.stroke()), F = !0; else {
                      x = a.axisX.convertValueToPixel(x); s =
                ...
                } X.drawMarkers(f); u && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
            ...
            var d = a.targetCanvasCtx ||
              this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var A = a.dataSeriesIndexes[l], h = this.data[A]; c.lineWidth = h.lineThickness; var n = h.dataPoints, r = "solid"; if (c.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness), r = h.lineDashType, g = N(r, h.lineThickness); c.setLineDash(g) } var w = h.id; this._eventManager.objectMap[w] =
                    { objectType: "dataSeries", dataSeriesIndex: A }; w = P(w); b.strokeStyle = w; b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var w = h._colorSet, k = w = h.lineColor = h.options.lineColor ? h.options.lineColor : w[0]; c.strokeStyle = w; var m = !0, t = 0, x, s; c.beginPath(); if (0 < n.length) {
                      for (var F = !1, t = 0; t < n.length; t++)if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F))) if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || F || m) && (c.stroke(),
                        u && b.stroke()), F = !0; else {
                          var B = s; x = a.axisX.convertValueToPixel(x); s = a.axisY.convertValueToPixel(n[t].y); var C = h.dataPointIds[t]; this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: x, y1: s }; m || F ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), r = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, B), c.lineTo(x, s), u && (b.lineTo(x,
            ...
            function d(a) {
              a = v(a, 2); if (0 < a.length) {
                b.beginPath(); u && e.beginPath(); b.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (b.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && b.setLineDash(a[0].newLineDashArray); u && e.moveTo(a[0].x, a[0].y); for (var c = 0; c < a.length - 3; c += 3)if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), u && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                  0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), u && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y)); b.stroke(); u && e.stroke()
              }
              ...
              b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                var A = a.dataSeriesIndexes[l], h = this.data[A]; b.lineWidth = h.lineThickness; var n = h.dataPoints, r = "solid"; if (b.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness), r = h.lineDashType, g = N(r, h.lineThickness); b.setLineDash(g) } var w = h.id; this._eventManager.objectMap[w] = { objectType: "dataSeries", dataSeriesIndex: A }; w = P(w); e.strokeStyle = w; e.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var w = h._colorSet,
              ...
              var b = null, e = this.plotArea, f = 0, p, l, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
                0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ?
                  this.dataPointWidth : -Infinity, f)); r < f && (r = f); r > n && (r = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], g = this.data[q], w = g.dataPoints; if (0 < w.length) for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < w.length; f++)if (w[f].getTime ? A = w[f].x.getTime() :
                      A = w[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[f].y) {
                        p = a.axisX.convertValueToPixel(A); l = a.axisY.convertValueToPixel(w[f].y); p = a.axisX.reversed ? p + a.plotType.totalDataSeries * r / 2 - (a.previousDataSeriesCount + n) * r << 0 : p - a.plotType.totalDataSeries * r / 2 + (a.previousDataSeriesCount + n) * r << 0; var m = a.axisX.reversed ? p - r << 0 : p + r << 0, t; 0 <= w[f].y ? t = h : (t = l, l = h); l > t && (b = l, l = t, t = b); b = w[f].color ? w[f].color : g._colorSet[f % g._colorSet.length]; ca(c, p, l, m, t, b, 0, null, k && 0 <= w[f].y,
                          0 > w[f].y && k, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: l, x2: m, y2: t }; b = P(b); u && ca(this._eventManager.ghostCtx, p, l, m, t, b, 0, null, !1, !1, !1, !1); (w[f].indexLabel || g.indexLabel || w[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "column", dataPoint: w[f], dataSeries: g, point: { x: p + (m - p) / 2, y: 0 > w[f].y === a.axisY.reversed ? l : t }, direction: 0 > w[f].y === a.axisY.reversed ? 1 : -1, bounds: {
                              x1: p,
                              y1: Math.min(l, t), x2: m, y2: Math.max(l, t)
                            }, color: b
                          })
                    }
                  ...
                  this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g < h && (g = h); g > n && (g = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                      var x = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                        n = a.axisX.convertValueToPixel(b); var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, F = s + g << 0, B; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]),
                          B = "undefined" !== typeof f[b] ? f[b] : q, f[b] = r); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = t[h].y + (A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = "undefined" !== typeof p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var C = "undefined" !== typeof f[b] ? f[b] : 0; r -= C; B = q - C; f[b] = C + (B - r) } else C = p[b] ? p[b] : 0, B = r + C, r = q + C, p[b] = C + (B - r); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; ca(c, s, r, F, B, b, 0, null, x && 0 <= t[h].y, 0 > t[h].y && x, !1,
                            !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: s, y1: r, x2: F, y2: B }; b = P(b); u && ca(this._eventManager.ghostCtx, s, r, F, B, b, 0, null, !1, !1, !1, !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                              chartType: "stackedColumn", dataPoint: t[h], dataSeries: m, point: { x: n, y: 0 <= t[h].y ? r : B }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: {
                                x1: s, y1: Math.min(r, B), x2: F, y2: Math.max(r,
                                  B)
                              }, color: b
                            })
                      }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], p = [], l = [], A = [], h = 0, n, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                this.options.dataPointWidth ? this.dataPointWidth : 1; n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && h > n && (h = Math.min(this.options.dataPointWidth ?
                  this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g < h && (g = h); g > n && (g = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var k = a.dataSeriesIndexes[w],
                    m = this.data[k], t = m.dataPoints; if (0 < t.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                      n = a.axisX.convertValueToPixel(b); r = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0; var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, F = s + g << 0, B; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                        l[b] = r +
                          ("undefined" !== typeof l[b] ? l[b] : 0); if (0 >= l[b]) continue; r = a.axisY.convertValueToPixel(l[b]); B = f[b] ? f[b] : q; f[b] = r
                      } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = r + ("undefined" !== typeof A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(r), 0 <= t[h].y) { var C = "undefined" !== typeof f[b] ? f[b] : 0; r -= C; B = q - C; a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.y1 - r) && (r = e.y1); f[b] = C + (B - r) } else C = "undefined" !== typeof p[b] ?
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var q = a.dataSeriesIndexes[n], g = this.data[q], w = g.dataPoints; if (0 < w.length) {
                  var k = 5 < r && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < w.length; f++)if (w[f].getTime ? A = w[f].x.getTime() : A = w[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[f].y) {
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], p = [], l = [], A = [], h = 0, n, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height <<
                0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && h > r && (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, r)); !this.dataPointMaxWidth && (this.dataPointMinWidth && r < h) && (r = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g <
                  h && (g = h); g > r && (g = r); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var k = a.dataSeriesIndexes[w], m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                      var x = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() :
                        t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                          r = a.axisX.convertValueToPixel(b); var s = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, F = s + g << 0, B; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (B = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(l[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = t[h].y + (A[b] ? A[b] : 0), n = p[b] ?
                            p[b] : q, p[b] = B = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var C = f[b] ? f[b] : 0; B = q + C; n += C; f[b] = C + (n - B) } else C = p[b] ? p[b] : 0, B = n - C, n = q - C, p[b] = C + (n - B); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; ca(c, B, s, n, F, b, 0, null, x, !1, !1, !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: B, y1: s, x2: n, y2: F }; b = P(b); u && ca(this._eventManager.ghostCtx, B, s, n, F, b, 0, null, !1, !1, !1,
                              !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? n : B, y: r }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(B, n), y1: s, x2: Math.max(B, n), y2: F }, color: b })
                      }
                    }
            ...
            var d =
              a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                  var k = a.dataSeriesIndexes[w], m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                    var s = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                      "number" === typeof t[h].y) {
                        r = a.axisX.convertValueToPixel(b); var z; z = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0; var F = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = F + g << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { l[b] = z + (l[b] ? l[b] : 0); if (0 >= l[b]) continue; z = f[b] ? f[b] : q; f[b] = n = a.axisY.convertValueToPixel(l[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = z + (A[b] ? A[b] : 0), n = p[b] ? p[b] :
                          q, p[b] = z = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(z), 0 <= t[h].y) { var C = f[b] ? f[b] : 0; z = q + C; n += C; a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x2 - n) && (n = e.x2); f[b] = C + (n - z) } else C = p[b] ? p[b] : 0, z = n - C, n = q - C, a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - z) && (z = e.x1), p[b] = C + (n - z); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; ca(c, z, F, n, B, b, 0, null, s, !1, !1, !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = {
                            ...
                            dataPointIndex: h, x1: z, y1: F, x2: n, y2: B
                          }; b = P(b); u && ca(this._eventManager.ghostCtx, z, F, n, B, b, 0, null, !1, !1, !1, !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? n : z, y: r }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, n), y1: F, x2: Math.max(z, n), y2: B }, color: b })
                    }
                  }
            ...
            var d, c; function b() { B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? F = z : 0 > a.axisY.viewportMaximum ? F = l.y1 : 0 < a.axisY.viewportMinimum && (F = z), f.lineTo(m, F), f.lineTo(B.x, F), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && (p.lineTo(m, F), p.lineTo(B.x, F), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, t), p.beginPath(), p.moveTo(m, t), B = { x: m, y: t }) }
            var e = a.targetCanvasCtx || this.plotArea.ctx, f = u ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
              var p = this._eventManager.ghostCtx, l = a.axisY.lineCoordinates, A = [], h = this.plotArea, n; f.save(); u && p.save(); f.beginPath(); f.rect(h.x1, h.y1, h.width, h.height); f.clip(); u && (p.beginPath(), p.rect(h.x1, h.y1, h.width, h.height), p.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                var q = a.dataSeriesIndexes[r], g = this.data[q], w = g.dataPoints, A = g.id; this._eventManager.objectMap[A] = { objectType: "dataSeries", dataSeriesIndex: q };
                A = P(A); p.fillStyle = A; A = []; d = !0; var k = 0, m, t, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), F, B = null; if (0 < w.length) {
                  var C = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, y = v; f.fillStyle = C; f.strokeStyle = v; f.lineWidth = g.lineThickness; c = "solid"; if (f.setLineDash) { var S = N(g.nullDataLineDashType, g.lineThickness); c = g.lineDashType; var R = N(c, g.lineThickness); f.setLineDash(R) } for (var ja = !0; k < w.length; k++)if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x, !(s < a.axisX.dataInfo.viewPortMin ||
                    s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))) if ("number" !== typeof w[k].y) g.connectNullData || (ja || d) || b(), ja = !0; else {
                      m = a.axisX.convertValueToPixel(s); t = a.axisY.convertValueToPixel(w[k].y); d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, B = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && p.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u &&
                        (p.beginPath(), p.moveTo(m, t)), B = { x: m, y: t }), ja = d = !1) : (f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b()); n = { x: m, y: t }; k < w.length - 1 && (y !== (w[k].lineColor || v) || c !== (w[k].lineDashType || g.lineDashType)) && (b(), y = w[k].lineColor || v, f.strokeStyle = y, f.setLineDash && (w[k].lineDashType ? (c = w[k].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(R)))); var Z = g.dataPointIds[k]; this._eventManager.objectMap[Z] = { id: Z, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }; 0 !== w[k].markerSize &&
                          (0 < w[k].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(k, m, t, f), A.push(s), Z = P(Z), u && A.push({ x: m, y: t, ctx: p, type: s.type, size: s.size, color: Z, borderColor: Z, borderThickness: s.borderThickness })); (w[k].indexLabel || g.indexLabel || w[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: w[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > w[k].y === a.axisY.reversed ? 1 : -1, color: C })
                    } b(); X.drawMarkers(A)
                }
        ...
        m.prototype.renderSplineArea = function (a) {
          function d() {
            var c = v(s, 2); if (0 < c.length) {
              if (0 < n.lineThickness) {
                ...
                m = f.y1 : 0 < a.axisY.viewportMinimum && (m = k); t = { x: c[0].x, y: c[0].y }; b.lineTo(c[c.length - 1].x, m); b.lineTo(t.x, m); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; u && (e.lineTo(c[c.length - 1].x, m), e.lineTo(t.x, m), e.closePath(), e.fill())
            }
          } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, p = [], l = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height);
            b.clip(); u && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
              var h = a.dataSeriesIndexes[A], n = this.data[h], r = n.dataPoints, p = n.id; this._eventManager.objectMap[p] = { objectType: "dataSeries", dataSeriesIndex: h }; p = P(p); e.fillStyle = p; var p = [], q = 0, g, w, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, t = null, s = []; if (0 < r.length) {
          ...
          var d, c; function b() {
            ...
            var p = this._eventManager.ghostCtx, l = a.axisY.lineCoordinates, A = [], h = this.plotArea, n; f.save(); u && p.save(); f.beginPath(); f.rect(h.x1, h.y1, h.width, h.height); f.clip(); u && (p.beginPath(), p.rect(h.x1, h.y1, h.width, h.height), p.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
              var q = a.dataSeriesIndexes[r], g = this.data[q], w = g.dataPoints,
              A = g.id; this._eventManager.objectMap[A] = { objectType: "dataSeries", dataSeriesIndex: q }; A = P(A); p.fillStyle = A; A = []; d = !0; var k = 0, m, t, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), F, B = null; c = !1; if (0 < w.length) {
                var C = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, y = v; f.fillStyle = C; f.strokeStyle = v; f.lineWidth = g.lineThickness; var S = "solid"; if (f.setLineDash) { var R = N(g.nullDataLineDashType, g.lineThickness), S = g.lineDashType, D = N(S, g.lineThickness); f.setLineDash(D) } for (; k <
                  w.length; k++)if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                    var Z = t; "number" !== typeof w[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(w[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, B = n, S = g.nullDataLineDashType,
                      ...
                      s = g.dataPointIds[k], this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }, 0 !== w[k].markerSize && (0 < w[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, t, f), A.push(Z), s = P(s), u && A.push({ x: m, y: t, ctx: p, type: Z.type, size: Z.size, color: s, borderColor: s, borderThickness: Z.borderThickness })), (w[k].indexLabel || g.indexLabel || w[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "stepArea", dataPoint: w[k], dataSeries: g, point: {
                          x: m,
                          y: t
                        }, direction: 0 > w[k].y === a.axisY.reversed ? 1 : -1, color: C
                      }))
                  } b(); X.drawMarkers(A)
              }
          ...
          function d() { if (!(1 > h.length)) { for (0 < C.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop(); b.lineTo(a.x, a.y); u && s.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = C.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); u && (s.closePath(), s.fill(), s.beginPath()); h = [] } } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx :
            c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, p = [], l = this.plotArea, A = [], h = [], n = [], r = [], q = 0, g, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, t, x, z; u && s.beginPath(); b.save(); u && s.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); u && (s.beginPath(), s.rect(l.x1, l.y1, l.width, l.height), s.clip()); for (var e = [], F = 0; F < a.dataSeriesIndexes.length; F++) {
                var B = a.dataSeriesIndexes[F], C = this.data[B], v = C.dataPoints; C.dataPointIndexes =
                  []; for (q = 0; q < v.length; q++)B = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[B] = q, e[B] || (n.push(B), e[B] = !0); n.sort(Oa)
              } for (F = 0; F < a.dataSeriesIndexes.length; F++) {
                B = a.dataSeriesIndexes[F]; C = this.data[B]; v = C.dataPoints; x = !0; h = []; q = C.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: B }; q = P(q); s.fillStyle = q; if (0 < n.length) {
                  var e = C._colorSet[0], y = C.lineColor = C.options.lineColor || e, S = y; b.fillStyle = e; b.strokeStyle = y; b.lineWidth = C.lineThickness; z = "solid"; if (b.setLineDash) {
                    var R =
                      N(C.nullDataLineDashType, C.lineThickness); z = C.lineDashType; var D = N(z, C.lineThickness); b.setLineDash(D)
                  } for (var Z = !0, q = 0; q < n.length; q++) {
                    var f = n[q], fa = null, fa = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z))) if ("number" !== typeof fa.y) C.connectNullData || (Z || x) || d(), Z = !0; else {
                      g = a.axisX.convertValueToPixel(f); var ma = A[f] ? A[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                        r[f] =
                        fa.y + (r[f] ? r[f] : 0); if (0 >= r[f] && a.axisY.logarithmic) continue; k = a.axisY.convertValueToPixel(r[f])
                      } else k = a.axisY.convertValueToPixel(fa.y), k -= ma; h.push({ x: g, y: m - ma }); A[f] = m - k; x || Z ? (!x && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || z === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (x = h.pop(), z = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(z), h.push(x), z = C.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, k), u && s.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), u && (s.beginPath(),
                        s.moveTo(g, k))), Z = x = !1) : (b.lineTo(g, k), u && s.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), u && s.moveTo(g, k), h.push({ x: g, y: m - ma }))); t = { x: g, y: k }; q < v.length - 1 && (S !== (v[q].lineColor || y) || z !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({ x: g, y: m - ma }), S = v[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (v[q].lineDashType ? (z = v[q].lineDashType, b.setLineDash(N(z, C.lineThickness))) : (z = C.lineDashType, b.setLineDash(D)))); if (0 <= C.dataPointIndexes[f]) {
                        ...
                        } 0 <= C.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < C.markerSize) && (ma = C.getMarkerProperties(C.dataPointIndexes[f], g, k, b), p.push(ma), f = P(E), u && p.push({ x: g, y: k, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness })); (fa.indexLabel || C.indexLabel || fa.indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "stackedArea",
                          dataPoint: fa, dataSeries: C, point: { x: g, y: k }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e
                        })
                    }
                  } d(); b.moveTo(g, k); u && s.moveTo(g, k)
                } delete C.dataPointIndexes
              } X.drawMarkers(p); u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), s.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
            }
        }; m.prototype.renderStackedArea100 = function (a) {
          function d() { for (0 < C.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop(); b.lineTo(a.x, a.y); u && z.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = C.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); u && (z.closePath(), z.fill(), z.beginPath()); h = [] }
          var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = null, f = null, p = this.plotArea, l = [], k = [], h = [], n = [], r = [], q = 0, g, w, m, s, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z = this._eventManager.ghostCtx; b.save(); u && z.save(); b.beginPath(); b.rect(p.x1, p.y1, p.width, p.height); b.clip(); u && (z.beginPath(), z.rect(p.x1, p.y1, p.width, p.height), z.clip()); for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
              ...
              C = this.data[B], y = C.dataPoints; C.dataPointIndexes = []; for (q = 0; q < y.length; q++)B = y[q].x.getTime ? y[q].x.getTime() : y[q].x, C.dataPointIndexes[B] = q, e[B] || (n.push(B), e[B] = !0); n.sort(Oa)
            } for (v = 0; v < a.dataSeriesIndexes.length; v++) {
              B = a.dataSeriesIndexes[v]; C = this.data[B]; y = C.dataPoints; s = !0; e = C.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: B }; e = P(e); z.fillStyle = e; h = []; if (0 < n.length) {
                var e = C._colorSet[q % C._colorSet.length], D = C.lineColor = C.options.lineColor || e, S = D; b.fillStyle = e; b.strokeStyle =
                  D; b.lineWidth = C.lineThickness; t = "solid"; if (b.setLineDash) { var R = N(C.nullDataLineDashType, C.lineThickness); t = C.lineDashType; var E = N(t, C.lineThickness); b.setLineDash(E) } for (var Z = !0, q = 0; q < n.length; q++) {
                    var f = n[q], fa = null, fa = 0 <= C.dataPointIndexes[f] ? y[C.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z))) if ("number" !== typeof fa.y) C.connectNullData || (Z || s) || d(), Z = !0; else {
                      var ma; ma = 0 !== a.dataPointYSums[f] ? 100 * (fa.y / a.dataPointYSums[f]) :
                  ...
                  } d(); b.moveTo(g, w); u && z.moveTo(g, w)
              } delete C.dataPointIndexes
            } X.drawMarkers(l); u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
          ...
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b =
              this.plotArea, e = 0, f, p; c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof q[e].z || (g = q[e].z, g > l && (l = g), g < k && (k = g)); for (var w = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, w), h = 0; h < a.dataSeriesIndexes.length; h++)if (n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                  f = a.axisX.convertValueToPixel(f); p = a.axisY.convertValueToPixel(q[e].y);
          ...
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this.plotArea, e = 0, f, p; c.save(); u && this._eventManager.ghostCtx.save();
            c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
              var k = a.dataSeriesIndexes[l], h = this.data[k], n = h.dataPoints; if (0 < n.length) {
                c.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2); for (var r = 0, q = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                    f = a.axisX.convertValueToPixel(f); p = a.axisY.convertValueToPixel(n[e].y); var g = h.getMarkerProperties(e, f, p, c); c.globalAlpha = h.fillOpacity; X.drawMarker(g.x, g.y, g.ctx, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; Math.sqrt((r - f) * (r - f) + (q - p) * (q - p)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (r = h.dataPointIds[e], this._eventManager.objectMap[r] = {
                      id: r, objectType: "dataPoint", dataSeriesIndex: k,
                      dataPointIndex: e, x1: f, y1: p
          ...
          function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, p = this.plotArea, l = 0, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff; isFinite(w) || (w = 0.3 * Math.abs(a.axisX.range)); w = this.options.dataPointWidth ?
                this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(w) / Math.log(a.axisX.range) : Math.abs(w) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); w < e && (w = e); w > f && (w = f); c.save(); u && b.save(); c.beginPath(); c.rect(p.x1, p.y1, p.width, p.height); c.clip(); u && (b.beginPath(), b.rect(p.x1, p.y1, p.width,
                  p.height), b.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var v = a.dataSeriesIndexes[m], t = this.data[v], x = t.dataPoints; if (0 < x.length) for (var z = 5 < w && t.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
                      k = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(x[l].y[0]);
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = this.plotArea, p = 0, l, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, p = this.options.dataPointMaxWidth ?
                this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff; isFinite(w) || (w = 0.3 * Math.abs(a.axisX.range)); w = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(w) / Math.log(a.axisX.range) : Math.abs(w) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > p && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < e) && (p = Math.max(this.options.dataPointWidth ?
                  this.dataPointWidth : -Infinity, e)); w < e && (w = e); w > p && (w = p); c.save(); u && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); u && (b.beginPath(), b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var t = a.dataSeriesIndexes[v], x = this.data[t], z = x.dataPoints; if (0 < z.length) for (var F = 5 < w && x.bevelEnabled ? !0 : !1, p = 0; p < z.length; p++)if (z[p].getTime ? g = z[p].x.getTime() : g = z[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                      !s(z[p].y) && z[p].y.length && "number" === typeof z[p].y[0] && "number" === typeof z[p].y[1] && "number" === typeof z[p].y[2] && "number" === typeof z[p].y[3] && "number" === typeof z[p].y[4] && 5 === z[p].y.length) {
                        l = a.axisX.convertValueToPixel(g); k = a.axisY.convertValueToPixel(z[p].y[0]); h = a.axisY.convertValueToPixel(z[p].y[1]); n = a.axisY.convertValueToPixel(z[p].y[2]); r = a.axisY.convertValueToPixel(z[p].y[3]); q = a.axisY.convertValueToPixel(z[p].y[4]); var B = l - w / 2 << 0, C = l + w / 2 << 0, e = z[p].color ? z[p].color : x._colorSet[0], y = Math.round(Math.max(1,
                          0.15 * w)), D = 0 === y % 2 ? 0 : 0.5, S = z[p].whiskerColor ? z[p].whiskerColor : z[p].color ? x.whiskerColor ? x.whiskerColor : z[p].color : x.whiskerColor ? x.whiskerColor : e, R = "number" === typeof z[p].whiskerThickness ? z[p].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y, E = z[p].whiskerDashType ? z[p].whiskerDashType : x.whiskerDashType, Z = s(z[p].whiskerLength) ? s(x.options.whiskerLength) ? w : x.whiskerLength : z[p].whiskerLength, Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= w ? w : Z : "string" === typeof Z ? parseInt(Z) * w / 100 >
                            w ? w : parseInt(Z) * w / 100 : w, fa = 1 === Math.round(R) % 2 ? 0.5 : 0, ma = z[p].stemColor ? z[p].stemColor : z[p].color ? x.stemColor ? x.stemColor : z[p].color : x.stemColor ? x.stemColor : e, ba = "number" === typeof z[p].stemThickness ? z[p].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y, G = 1 === Math.round(ba) % 2 ? 0.5 : 0, J = z[p].stemDashType ? z[p].stemDashType : x.stemDashType, I = z[p].lineColor ? z[p].lineColor : z[p].color ? x.lineColor ? x.lineColor : z[p].color : x.lineColor ? x.lineColor : e, M = "number" === typeof z[p].lineThickness ?
                              z[p].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y, Q = z[p].lineDashType ? z[p].lineDashType : x.lineDashType, K = 1 === Math.round(M) % 2 ? 0.5 : 0, V = x.upperBoxColor, wa = x.lowerBoxColor, ra = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[p]; this._eventManager.objectMap[O] = {
                                id: O, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: p, x1: B, y1: k, x2: C, y2: h, x3: l, y3: n, x4: l, y4: r, y5: q, borderThickness: y, color: e, stemThickness: ba, stemColor: ma, whiskerThickness: R, whiskerLength: Z, whiskerColor: S,
                                lineThickness: M, lineColor: I
                              }; c.save(); 0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(l - G, h), c.lineTo(l - G, k), c.stroke(), c.moveTo(l - G, r), c.lineTo(l - G, n), c.stroke()); c.restore(); b.lineWidth = Math.max(y, 4); c.beginPath(); ca(c, B, Math.min(q, h), C, Math.max(h, q), wa, 0, e, m ? F : !1, m ? !1 : F, !1, !1, ra); c.beginPath(); ca(c, B, Math.min(n, q), C, Math.max(q, n), V, 0, e, m ? !1 : F, m ? F : !1, !1, !1, ra); c.beginPath(); c.lineWidth = y; c.strokeStyle = e; c.rect(B - D, Math.min(h, n) - D, C - B + 2 * D, Math.max(h,
                                n) - Math.min(h, n) + 2 * D); c.stroke(); c.save(); 0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(N(Q, M)), c.strokeStyle = I, c.lineWidth = M, c.moveTo(B, q - K), c.lineTo(C, q - K), c.stroke()); c.restore(); c.save(); 0 < R && (c.beginPath(), c.setLineDash && c.setLineDash(N(E, R)), c.strokeStyle = S, c.lineWidth = R, c.moveTo(l - Z / 2 << 0, r - fa), c.lineTo(l + Z / 2 << 0, r - fa), c.stroke(), c.moveTo(l - Z / 2 << 0, k + fa), c.lineTo(l + Z / 2 << 0, k + fa), c.stroke()); c.restore(); u && (e = P(O), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(l - D - G, h), b.lineTo(l -
                                  D - G, Math.max(k, r)), b.stroke(), b.moveTo(l - D - G, Math.min(k, r)), b.lineTo(l - D - G, n), b.stroke()), ca(b, B, Math.max(h, n), C, Math.min(h, n), e, 0, null, !1, !1, !1, !1), 0 < R && (b.beginPath(), b.lineWidth = R, b.moveTo(l + Z / 2, r - fa), b.lineTo(l - Z / 2, r - fa), b.stroke(), b.moveTo(l + Z / 2, k + fa), b.lineTo(l - Z / 2, k + fa), b.stroke())); (z[p].indexLabel || x.indexLabel || z[p].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: x.type, dataPoint: z[p], dataSeries: x, point: { x: B + (C - B) / 2, y: a.axisY.reversed ? k : r }, direction: 1, bounds: {
                                      x1: B,
                                      y1: Math.min(k, r), x2: C, y2: Math.max(k, r)
                                    }, color: e
                                  })
                    }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = 0, p, l, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                0.03 * this.width; var h = a.axisX.dataInfo.minDiff; isFinite(h) || (h = 0.3 * Math.abs(a.axisX.range)); h = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > p && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity,
                  f)); h < f && (h = f); h > p && (h = p); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var r = a.dataSeriesIndexes[n], q = this.data[r], g = q.dataPoints; if (0 < g.length) for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
                      k > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                        b = a.axisX.convertValueToPixel(k); p = a.axisY.convertValueToPixel(g[f].y[0]); l = a.axisY.convertValueToPixel(g[f].y[1]); var ka = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + n) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + n) * h << 0, v = a.axisX.reversed ? ka - h << 0 : ka + h << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (p > l) {
                          var t = p;
                          p = l; l = t
                        } t = q.dataPointIds[f]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: ka, y1: p, x2: v, y2: l }; ca(c, ka, p, v, l, b, 0, b, m, m, !1, !1, q.fillOpacity); b = P(t); u && ca(this._eventManager.ghostCtx, ka, p, v, l, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                          chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: ka + (v - ka) / 2, y: g[f].y[1] >= g[f].y[0] ? l : p }, direction: g[f].y[1] >=
                            g[f].y[0] ? -1 : 1, bounds: { x1: ka, y1: Math.min(p, l), x2: v, y2: Math.max(p, l) }, color: b
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx :
              d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, p = this.plotArea, l = 0, k, h, n, r, q, g, m, ka = a.axisX.dataInfo.minDiff; isFinite(ka) || (ka = 0.3 * Math.abs(a.axisX.range)); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(p.x1, p.y1, p.width, p.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.clip()); for (var v =
                  0, t = 0; t < this.data.length; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && v || v++; for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var z = a.dataSeriesIndexes[x], F = this.data[z], B = F.dataPoints, C = s(F._linkedSeries) ? !1 : F._linkedSeries.type.match(/(bar|column)/ig) && F._linkedSeries.visible ? !0 : !1, D = 0; if (C) for (e = F._linkedSeries.id, t = 0; t < e; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) &&
                      D || (this.data[t].type.match(/(range)/ig) && (f = !0), D++); e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? v : 1))) << 0 : 0.3 * this.width; f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height /
                        (C ? v : 1))) << 0 : 0.03 * this.width); t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(ka) / Math.log(a.axisX.range) : Math.abs(ka) / Math.abs(a.axisX.range)) / (C ? v : 1)) << 0; this.dataPointMaxWidth && e > l && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < e) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); t < e && (t = e); t > l && (t = l); if (0 < B.length) for (var E = F._colorSet,
                          l = 0; l < B.length; l++) {
                            var e = F.lineColor = F.options.color ? F.options.color : E[0], S = {
                              color: B[l].whiskerColor ? B[l].whiskerColor : B[l].color ? F.whiskerColor ? F.whiskerColor : B[l].color : F.whiskerColor ? F.whiskerColor : e, thickness: s(B[l].whiskerThickness) ? F.whiskerThickness : B[l].whiskerThickness, dashType: B[l].whiskerDashType ? B[l].whiskerDashType : F.whiskerDashType, length: s(B[l].whiskerLength) ? s(F.options.whiskerLength) ? t : F.options.whiskerLength : B[l].whiskerLength, trimLength: s(B[l].whiskerLength) ? s(F.options.whiskerLength) ?
                                50 : 0 : 0
                            }; S.length = "number" === typeof S.length ? 0 >= S.length ? 0 : S.length >= t ? t : S.length : "string" === typeof S.length ? parseInt(S.length) * t / 100 > t ? t : parseInt(S.length) * t / 100 > t : t; S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2; var R = { color: B[l].stemColor ? B[l].stemColor : B[l].color ? F.stemColor ? F.stemColor : B[l].color : F.stemColor ? F.stemColor : e, thickness: B[l].stemThickness ? B[l].stemThickness : F.stemThickness, dashType: B[l].stemDashType ? B[l].stemDashType : F.stemDashType }; R.thickness =
                              "number" === typeof R.thickness ? 0 > R.thickness ? 0 : Math.round(R.thickness) : 2; B[l].getTime ? m = B[l].x.getTime() : m = B[l].x; if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !s(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                var ja = a.axisX.convertValueToPixel(m); b ? h = ja : k = ja; ja = a.axisY.convertValueToPixel(B[l].y[0]); b ? n = ja : q = ja; ja = a.axisY.convertValueToPixel(B[l].y[1]); b ? r = ja : g = ja; b ? (q = a.axisX.reversed ? h + (C ? v : 1) * t / 2 - (C ? D - 1 : 0) * t << 0 : h - (C ? v : 1) * t / 2 + (C ? D - 1 : 0) *
                                  t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? k + (C ? v : 1) * t / 2 - (C ? D - 1 : 0) * t << 0 : k - (C ? v : 1) * t / 2 + (C ? D - 1 : 0) * t << 0, r = a.axisX.reversed ? n - t << 0 : n + t << 0); !b && q > g && (ja = q, q = g, g = ja); b && n > r && (ja = n, n = r, r = ja); ja = F.dataPointIds[l]; this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: l, x1: Math.min(n, r), y1: Math.min(q, g), x2: Math.max(r, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: R, whiskerProperties: S }; y(c, Math.min(n, r), Math.min(q, g), Math.max(r, n), Math.max(g, q), e,
                                    S, R, b); u && y(this._eventManager.ghostCtx, n, q, r, g, e, S, R, b); if (B[l].indexLabel || F.indexLabel || B[l].indexLabelFormatter || F.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: B[l], dataSeries: F, indexKeyword: 0, point: { x: b ? B[l].y[1] >= B[l].y[0] ? n : r : n + (r - n) / 2, y: b ? q + (g - q) / 2 : B[l].y[1] >= B[l].y[0] ? g : q }, direction: B[l].y[1] >= B[l].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, r) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, r) : r, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }), this._indexLabels.push({
                                      chartType: "error",
                                      dataPoint: B[l], dataSeries: F, indexKeyword: 1, point: { x: b ? B[l].y[1] >= B[l].y[0] ? r : n : n + (r - n) / 2, y: b ? q + (g - q) / 2 : B[l].y[1] >= B[l].y[0] ? q : g }, direction: B[l].y[1] >= B[l].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(n, r) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, r) : r, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b
                                    })
                              }
                        }
                ...
                null, e = this.plotArea, f = 0, p, l, k, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0; var n = a.axisX.dataInfo.minDiff; isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range)); n = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) :
                  Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > p && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); n < f && (n = f); n > p && (n = p); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                      var q = a.dataSeriesIndexes[r], g = this.data[q], m = g.dataPoints; if (0 < m.length) {
                        var ka = 5 < n && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < m.length; f++)if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                          p = a.axisY.convertValueToPixel(m[f].y[0]); l = a.axisY.convertValueToPixel(m[f].y[1]);
                          k = a.axisX.convertValueToPixel(h); k = a.axisX.reversed ? k + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + r) * n << 0 : k - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + r) * n << 0; var v = a.axisX.reversed ? k - n << 0 : k + n << 0; p > l && (b = p, p = l, l = b); b = m[f].color ? m[f].color : g._colorSet[f % g._colorSet.length]; ca(c, p, k, l, v, b, 0, null, ka, !1, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: k, x2: l, y2: v }; b = P(b); u && ca(this._eventManager.ghostCtx,
                            p, k, l, v, b, 0, null, !1, !1, !1, !1); if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: m[f], dataSeries: g, indexKeyword: 0, point: { x: m[f].y[1] >= m[f].y[0] ? p : l, y: k + (v - k) / 2 }, direction: m[f].y[1] >= m[f].y[0] ? -1 : 1, bounds: { x1: Math.min(p, l), y1: k, x2: Math.max(p, l), y2: v }, color: b }), this._indexLabels.push({
                              chartType: "rangeBar", dataPoint: m[f], dataSeries: g, indexKeyword: 1, point: { x: m[f].y[1] >= m[f].y[0] ? l : p, y: k + (v - k) / 2 }, direction: m[f].y[1] >=
                                m[f].y[0] ? 1 : -1, bounds: { x1: Math.min(p, l), y1: k, x2: Math.max(p, l), y2: v }, color: b
                            })
                        }
                      }
            ...
            function d() {
              if (x) {
                for (var a = null, c = k.length - 1; 0 <= c; c--)a = k[c], b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; e.fill(); if (0 < n.lineThickness) {
                ...
                } b.beginPath(); b.moveTo(m, s); e.beginPath(); e.moveTo(m, s); x = { x: m, y: s }; k = []; k.push({ x: m, y1: s, y2: v })
              }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, f = [], p = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(p.x1, p.y1, p.width, p.height); b.clip(); u && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                n = this.data[h], r = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: h }; f = P(f); e.fillStyle = f; var f = [], q = !0, g = 0, m, s, v, t, x = null; if (0 < r.length) {
                  var z = n._colorSet[g % n._colorSet.length], F = n.lineColor = n.options.lineColor || z, B = F; b.fillStyle = z; b.strokeStyle = F; b.lineWidth = n.lineThickness; var C = "solid"; if (b.setLineDash) { var y = N(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType, D = N(C, n.lineThickness); b.setLineDash(D) } for (var S = !0; g < r.length; g++)if (t = r[g].x.getTime ?
                    r[g].x.getTime() : r[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S))) if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                      m = a.axisX.convertValueToPixel(t); s = a.axisY.convertValueToPixel(r[g].y[0]); v = a.axisY.convertValueToPixel(r[g].y[1]); q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, C = n.nullDataLineDashType,
                        b.setLineDash(y)), b.lineTo(m, s), u && e.lineTo(m, s), k.push({ x: m, y1: s, y2: v })) : (b.beginPath(), b.moveTo(m, s), x = { x: m, y: s }, k = [], k.push({ x: m, y1: s, y2: v }), u && (e.beginPath(), e.moveTo(m, s))), S = q = !1) : (b.lineTo(m, s), k.push({ x: m, y1: s, y2: v }), u && e.lineTo(m, s), 0 == g % 250 && d()); t = n.dataPointIds[g]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: m, y1: s, y2: v }; g < r.length - 1 && (B !== (r[g].lineColor || F) || C !== (r[g].lineDashType || n.lineDashType)) && (d(), B = r[g].lineColor || F, k[k.length -
                          1].newStrokeStyle = B, b.strokeStyle = B, b.setLineDash && (r[g].lineDashType ? (C = r[g].lineDashType, k[k.length - 1].newLineDashArray = N(C, n.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (C = n.lineDashType, k[k.length - 1].newLineDashArray = D, b.setLineDash(D)))); if (0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < n.markerSize)) {
                            var R = n.getMarkerProperties(g, m, v, b); f.push(R); var E = P(t); u && f.push({ x: m, y: v, ctx: e, type: R.type, size: R.size, color: E, borderColor: E, borderThickness: R.borderThickness }); R = n.getMarkerProperties(g,
                              m, s, b); f.push(R); E = P(t); u && f.push({ x: m, y: s, ctx: e, type: R.type, size: R.size, color: E, borderColor: E, borderThickness: R.borderThickness })
                            ...
                            chartType: "rangeArea", dataPoint: r[g], dataSeries: n, indexKeyword: 1, point: { x: m, y: v }, direction: r[g].y[0] >
                              r[g].y[1] === a.axisY.reversed ? 1 : -1, color: z
                          })
            ...
            function d(a, c) {
              var d = v(s, 2); if (0 < d.length) {
                if (0 < h.lineThickness) {
                  ...
                  d[f - 2].y, d[f - 3].x, d[f - 3].y), u && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); b.closePath(); b.globalAlpha = h.fillOpacity; b.fill(); u && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < h.lineThickness) {
                    b.strokeStyle = c; b.setLineDash && b.setLineDash(a); b.beginPath(); b.moveTo(d[0].x, d[0].y); for (var g = f = 0; f < d.length - 3; f += 3, g++) {
                      if (s[g].newStrokeStyle || s[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), s[g].newStrokeStyle && (b.strokeStyle = s[g].newStrokeStyle), s[g].newLineDashArray &&
                        b.setLineDash(s[g].newLineDashArray); b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                    } d = v(s, 2); b.moveTo(d[0].x, d[0].y); for (g = f = 0; f < d.length - 3; f += 3, g++) { if (s[g].newStrokeStyle || s[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), s[g].newStrokeStyle && (b.strokeStyle = s[g].newStrokeStyle), s[g].newLineDashArray && b.setLineDash(s[g].newLineDashArray); b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y) } b.stroke()
                  } b.beginPath()
              }
            } var c = a.targetCanvasCtx ||
              this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], p = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(p.x1, p.y1, p.width, p.height); b.clip(); u && (e.beginPath(), e.rect(p.x1, p.y1, p.width, p.height), e.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var k = a.dataSeriesIndexes[l], h = this.data[k], n = h.dataPoints, f = h.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = P(f); e.fillStyle = f; var f = [], r = 0, q,
                    g, m, s = [], y = []; if (0 < n.length) {
                      var t = h._colorSet[r % h._colorSet.length], x = h.lineColor = h.options.lineColor || t, z = x; b.fillStyle = t; b.lineWidth = h.lineThickness; var F = "solid", B; if (b.setLineDash) { var C = N(h.nullDataLineDashType, h.lineThickness), F = h.lineDashType; B = N(F, h.lineThickness) } for (g = !1; r < n.length; r++)if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" ===
                        typeof n[r].y[1]) {
                          q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(n[r].y[0]); m = a.axisY.convertValueToPixel(n[r].y[1]); var D = h.dataPointIds[r]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: r, x1: q, y1: g, y2: m }; s[s.length] = { x: q, y: g }; y[y.length] = { x: q, y: m }; r < n.length - 1 && (z !== (n[r].lineColor || x) || F !== (n[r].lineDashType || h.lineDashType)) && (z = n[r].lineColor || x, s[s.length - 1].newStrokeStyle = z, b.setLineDash && (n[r].lineDashType ? (F = n[r].lineDashType,
                            s[s.length - 1].newLineDashArray = N(F, h.lineThickness)) : (F = h.lineDashType, s[s.length - 1].newLineDashArray = B))); if (0 !== n[r].markerSize && (0 < n[r].markerSize || 0 < h.markerSize)) { var E = h.getMarkerProperties(r, q, g, b); f.push(E); var S = P(D); u && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: S, borderColor: S, borderThickness: E.borderThickness }); E = h.getMarkerProperties(r, q, m, b); f.push(E); S = P(D); u && f.push({ x: q, y: m, ctx: e, type: E.type, size: E.size, color: S, borderColor: S, borderThickness: E.borderThickness }) } if (n[r].indexLabel ||
                              h.indexLabel || n[r].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[r], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: n[r].y[0] <= n[r].y[1] ? -1 : 1, color: t }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[r], dataSeries: h, indexKeyword: 1, point: { x: q, y: m }, direction: n[r].y[0] <= n[r].y[1] ? 1 : -1, color: t }); g = !1
                      } else 0 < r && !g && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (s[s.length -
                        1].newLineDashArray = C, F = h.nullDataLineDashType) : (d(B, x), s = [], y = [])), g = !0; d(B, x); X.drawMarkers(f)
                    }
                } u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height),
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, p = 0, l, k, h, n, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), p = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                this.options.dataPointWidth ? this.dataPointWidth : 1; k = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0; var q = a.axisX.dataInfo.minDiff; isFinite(q) || (q = 0.3 * Math.abs(a.axisX.range)); q = this.options.dataPointWidth ? this.dataPointWidth : 0.6 * (f.width * (a.axisX.logarithmic ? Math.log(q) / Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth &&
                  p > k && (p = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, k)); !this.dataPointMaxWidth && (this.dataPointMinWidth && k < p) && (k = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, p)); q < p && (q = p); q > k && (q = k); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.clip()); for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var m =
                      a.dataSeriesIndexes[g], s = this.data[m], v = s.dataPoints, e = s._colorSet[0]; s.risingColor = s.options.risingColor ? s.options.risingColor : e; s.fallingColor = s.options.fallingColor ? s.options.fallingColor : "#e40a0a"; var t = "number" === typeof s.options.lineThickness ? Math.round(s.lineThickness) : 1, x = 1 === Math.round(t) % 2 ? -0.5 : 0; if (0 < v.length) for (var z = 5 < q && s.bevelEnabled ? !0 : !1, F = !1, B = null, C = null, p = 0; p < v.length; p++)if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x, "number" !== typeof v[p].y) {
                        if (0 < p && !F && s.connectNullData) var y =
                          s.options.nullDataLineDashType || !v[p - 1].lineDashType ? s.nullDataLineDashType : v[p - 1].lineDashType; F = !0
                      } else {
                        l = a.axisX.convertValueToPixel(n); k = 0 === s.dataPointEOs[p].cumulativeSum ? r : a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSum); h = 0 === s.dataPointEOs[p].cumulativeSumYStartValue ? r : a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSumYStartValue); l = a.axisX.reversed ? l + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : l - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount +
            ...
            function d() {
              if (h &&
                n) {
                  for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    var f = n[e], p = h.dataPointIds[e]; g[e].id = p; g[e].objectType = "dataPoint"; g[e].dataPointIndex = e; g[e].dataSeriesIndex = 0; var l = g[e], r = { percent: null, total: null }, m = null, r = k.getPercentAndTotal(h, f); if (h.indexLabelFormatter || f.indexLabelFormatter) m = { chart: k.options, dataSeries: h, dataPoint: f, total: r.total, percent: r.percent }; r = f.indexLabelFormatter ? f.indexLabelFormatter(m) : f.indexLabel ? k.replaceKeywordsWithValue(f.indexLabel, f, h, e) : h.indexLabelFormatter ? h.indexLabelFormatter(m) :
                    ...
                    l.startAngle = (l.startAngle + 2 * Math.PI) % (2 * Math.PI); l.endAngle = l.startAngle + 2 * Math.PI / y * Math.abs(f.y); f = (l.endAngle + l.startAngle) / 2; f = (f + 2 * Math.PI) % (2 * Math.PI); l.midAngle = f; if (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > l.midAngle) c = e; a++ } else if (l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > l.midAngle) d = e; b++ } l.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; l.indexLabelTextBlock = new ia(k.plotArea.ctx, {
                      fontSize: l.indexLabelFontSize, fontFamily: l.indexLabelFontFamily,
                  ...
                  } p = f = 0; r = !1; for (e = 0; e < n.length; e++)l = g[(c + e) % n.length], 1 < a && (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !r ? (l.hemisphere = "right",
                    f++) : (l.hemisphere = "left", r = !0)); r = !1; for (e = 0; e < n.length; e++)l = g[(d + e) % n.length], 1 < b && (l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t) && (p <= b / 2 && !r ? (l.hemisphere = "left", p++) : (l.hemisphere = "right", r = !0))
              }
            } function c(a) {
              var b = k.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = k.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
              ...
              for (var c = null, d = 1; d < n.length; d++)if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) { c = null; break } else if (g[c].indexLabelText && c !==
              ...
              d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var h = 0, l = z.y - 1 * u, p = z.y + 1 * u; if (0 <= a && a < n.length) {
                var k = g[a]; if (0 > c && k.indexLabelTextBlock.y < l || 0 < c && k.indexLabelTextBlock.y > p) return 0; var q = 0, r = 0, r = q = q = 0; 0 > c ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > l && k.indexLabelTextBlock.y - k.indexLabelTextBlock.height /
              ...
              var a = k.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline =
                "middle"; for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && C - d <= D) l = !1; l && (C -= d); d = 0; if ("inside" !== h.indexLabelPlacement) {
                    u = C * v; for (a = 0; a < n.length; a++) { var p = g[a]; p.indexLabelTextBlock.x = z.x + u * Math.cos(p.midAngle); p.indexLabelTextBlock.y = z.y + u * Math.sin(p.midAngle); p.indexLabelAngle = p.midAngle; p.radius = C; p.percentInnerRadius = E } for (var s, t, a = 0; a < n.length; a++) {
                      var p = g[a], B = e(a); if (null !== B) {
                        s = g[a]; t = g[B]; var y = 0, y = b(s, t) -
                          m; if (0 > y) { for (var F = t = 0, J = 0; J < n.length; J++)J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? t++ : F++); t = y / (t + F || 1) * F; var F = -1 * (y - t), I = J = 0; "right" === p.hemisphere ? (J = f(a, t), F = -1 * (y - J), I = f(B, F), +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(a, -(F - I))) : (J = f(B, t), F = -1 * (y - J), I = f(a, F), +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(B, -(F - I))) }
                      }
                    }
                  } else for (a = 0; a < n.length; a++)p = g[a], u = "pie" === h.type ? 0.7 * C : 0.8 * C, B = z.x + u * Math.cos(p.midAngle),
                    t = z.y + u * Math.sin(p.midAngle), p.indexLabelTextBlock.x = B, p.indexLabelTextBlock.y = t; for (a = 0; a < n.length; a++)if (p = g[a], B = p.indexLabelTextBlock.measureText(), 0 !== B.height && 0 !== B.width) B = B = 0, "right" === p.hemisphere ? (B = q.x2 - (p.indexLabelTextBlock.x + p.indexLabelTextBlock.width + r), B *= -1) : B = q.x1 - (p.indexLabelTextBlock.x - p.indexLabelTextBlock.width - r), 0 < B && (!l && p.indexLabelText && (t = "right" === p.hemisphere ? q.x2 - p.indexLabelTextBlock.x : p.indexLabelTextBlock.x - q.x1, 0.3 * p.indexLabelTextBlock.maxWidth > t ? p.indexLabelText =
                      "" : p.indexLabelTextBlock.maxWidth = 0.85 * t, 0.3 * p.indexLabelTextBlock.maxWidth < t && (p.indexLabelTextBlock.x -= "right" === p.hemisphere ? 2 : -2)), Math.abs(p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - z.y) < C || Math.abs(p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 - z.y) < C) && (B /= Math.abs(Math.cos(p.indexLabelAngle)), 9 < B && (B *= 0.3), B > d && (d = B)), B = B = 0, 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? (B = q.y2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + 5), B *= -1) : B = q.y1 - (p.indexLabelTextBlock.y -
                        p.indexLabelTextBlock.height / 2 - 5), 0 < B && (!l && p.indexLabelText && (t = 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, B * t) && f(a, 2 * t)), Math.abs(p.indexLabelTextBlock.x - z.x) < C && (B /= Math.abs(Math.sin(p.indexLabelAngle)), 9 < B && (B *= 0.3), B > d && (d = B))); var K = function (a, b, c) {
                          for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + n.length) % n.length); d.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < d.length; b++)if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText();
                          else break
                        }; (function () {
                          for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < n.length; h++)if (f = !1, s = g[h], s.indexLabelText) {
                            var p = e(h); if (null !== p) {
                              var l = g[p]; y = 0; y = b(s, l); var k; if (k = 0 > y) {
              ...
              k.plotArea.layoutManager.reset(); k.title && (k.title.dockInsidePlotArea || "center" === k.title.horizontalAlign && "center" === k.title.verticalAlign) && k.title.render(); if (k.subtitles) for (var a = 0; a < k.subtitles.length; a++) {
                var b = k.subtitles[a]; (b.dockInsidePlotArea || "center" ===
              ...
              var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, r = 10, q = this.plotArea, g = h.dataPointEOs, m = 2, u, v = 1.3, t = 20 / 180 * Math.PI, x = 6, z = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, y = 0; a = !1; for (var B = 0; B < n.length; B++)y += Math.abs(n[B].y), !a && ("undefined" !== typeof n[B].indexLabel &&
                null !== n[B].indexLabel && 0 < n[B].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[B].label && null !== n[B].label && 0 < n[B].label.toString().length) && (a = !0); if (0 !== y) {
                  a = a || "undefined" !== typeof h.indexLabel && null !== h.indexLabel && 0 < h.indexLabel.toString().length; var C = "inside" !== h.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; h.radius && (C = Qa(h.radius, C)); var D = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Qa(h.innerRadius, C) : 0.7 * C; h.radius =
                    C; "doughnut" === h.type && (h.innerRadius = D); var E = Math.min(D / C, (C - 1) / C); this.pieDoughnutClickHandler = function (a) { k.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && k._animator.animate(0, 500, function (a) { c(a); l() })) }; d(); p(); p(); p(); p(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
            ...
            function d() {
              for (var a =
                0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1; x[c].y = "number" === typeof x[c].y ? x[c].y : 0; a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++)b.push(Math.abs(x[c].y) * D / a); return b
            } function c() {
              var a = W, b = $, c = K, d = X, e, f; e = Z; f = Q - ba; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = X - K; e = f - e; f = c * (f - Q); f = Math.abs(f); f = d + f; for (var d = [], g = 0, h = 0; h < x.length; h++) { if ("undefined" === typeof x[h].y) return -1; x[h].y = "number" === typeof x[h].y ? x[h].y : 0; g += Math.abs(x[h].y) } if (0 === g) return -1; for (var p = d[0] =
                0, l = 0, k, n, b = b - a, p = !1, h = 0; h < x.length; h++)a = Math.abs(x[h].y) * f / g, p ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > n ? (n = c, p = (b + n) * (e - l) / 2, a -= p, k = e - l, l += e - l, k += 0 == n ? 0 : a / n, l += a / n, p = !0) : (k = (Math.abs(aa) * b - Math.sqrt(n)) / 2, n = b - 2 * k / Math.abs(aa), l += k, l > e && (l -= k, n = c, p = (b + n) * (e - l) / 2, a -= p, k = e - l, l += e - l, k += a / n, l += a / n, p = !0), b = n)), d.push(k); return d
            } function b() {
              if (t && x) {
                for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, w = [], A = [], v = { percent: null, total: null }, B = null, z = 0; z < x.length; z++)m = O[z], m = "undefined" !== typeof m.x5 ?
                  (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, w[z] = M - m - V; m = 0.5 * V; for (var z = 0, C = x.length - 1; z < x.length || 0 <= C; z++, C--) {
                    b = t.reversed ? x[C] : x[z]; a = b.color ? b.color : t.reversed ? t._colorSet[(x.length - 1 - z) % t._colorSet.length] : t._colorSet[z % t._colorSet.length]; c = b.indexLabelPlacement || t.indexLabelPlacement || "outside"; d = b.indexLabelBackgroundColor || t.indexLabelBackgroundColor || (u ? "transparent" : null); e = b.indexLabelFontColor || t.indexLabelFontColor || "#979797"; f = s(b.indexLabelFontSize) ? t.indexLabelFontSize : b.indexLabelFontSize;
              ...
              var a, b, c, d, e, f = []; e = !1; c = 0; for (var g, h = M - $ - V / 2, h = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth >
              ...
              var a, b, c, d; if ("inside" !== t.indexLabelPlacement) for (var e = 0; e < O.length; e++)0 == H[e].textBlock.text.length ?
                H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, t.reversed ? (H[e].textBlock.y + H[e].height > T + F && (H[e].textBlock.y = T + F - H[e].height), H[e].textBlock.y < ra - F && (H[e].textBlock.y = ra - F)) : (H[e].textBlock.y < T - F && (H[e].textBlock.y = T - F), H[e].textBlock.y + H[e].height > ra + F &&
                  (H[e].textBlock.y = ra + F - H[e].height))); else for (e = 0; e < O.length; e++)0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
            } function p() {
              function a(b, c) {
                var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) {
                  c *= -1; e = r(b); d = l(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d; d += a(e, -(c - d)); 0 < d && (f.y -=
                    d); return d
                } e = q(b); d = l(b, e); if (d >= c) return f.y += c, c; if (b == O.length - 1) return 0 < d && (f.y += d), d; d += a(e, c - d); 0 < d && (f.y += d); return d
              } function b() {
                var a, d, e, f, g = 0, h; f = (Q - Z + 2 * F) / k; h = k; for (var l, p = 1; p < h; p++) { e = p * f; for (var n = H.length - 1; 0 <= n; n--)!H[n].isDirty && (H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e) && (l = q(n), !(l >= H.length - 1) && H[n].textBlock.y + H[n].height + da > H[l].textBlock.y && (H[n].textBlock.y = H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y ? e + 1 : e - H[n].height - 1)) } for (l = O.length - 1; 0 < l; l--)if (!H[l].isDirty) {
                  e =
                  r(l); if (0 > e && (e = 0, H[e].isDirty)) break; if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) { d = d || l; f = l; for (h = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) { a = a || H[f].textBlock.y + H[f].height; h += H[f].height; h += da; f = e; if (0 >= f) { f = 0; h += H[f].height; break } e = r(f); if (0 > e) { f = 0; h += H[f].height; break } } if (f != l) { g = H[f].textBlock.y; a -= g; a = h - a; g = c(a, d, f); break } }
                } return g
              } function c(a, b, d) {
                var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++)e.push(O[d]); e.sort(function (a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)if (b =
                  e[d], f < a) g++, f += H[b.id].height + da, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break; return g
              } for (var d, e, f, g, h, p, k = 1, n = 0; n < 2 * k; n++) { for (var m = H.length - 1; 0 <= m && !(0 <= r(m) && r(m), f = H[m], g = f.textBlock, p = (h = q(m) < O.length ? H[q(m)] : null) ? h.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (h && e + d + da > +p.y.toFixed(6)) && (d = g.y + d + da - p.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--); b() }
            } function l(a, b) {
              return (b < O.length ? H[b].textBlock.y :
                t.reversed ? T + F : ra + F) - (0 > a ? t.reversed ? ra - F : T - F : H[a].textBlock.y + H[a].height + da)
            } function k(a, b, c) {
              var d, e, g, l = [], p = F, r = []; -1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function (a, b) { return a - b }))); if (0 === Y.length) l = ga; else { e = F * (1 != Y.length || 0 != Y[0] && Y[0] != O.length - 1 ? 2 : 1) / h(); for (var q = 0; q < O.length; q++) { if (1 == Y.length && 0 == Y[0]) { if (0 === q) { l.push(ga[q]); d = p; continue } } else 0 === q && (d = -1 * p); l.push(ga[q] + d); if (0 <= Y.indexOf(q) || q < O.length && 0 <= Y.indexOf(q + 1)) d += e } } g = function () {
                for (var a =
                  [], b = 0; b < O.length; b++)a.push(l[b] - O[b].y1); return a
              }(); var s = { startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, d) { return L.easing.easeOutQuart(a, b, c, d) }, changeSection: function (a) { for (var b, c, d = 0; d < O.length; d++)b = g[d], c = O[d], b *= a, "undefined" === typeof r[d] && (r[d] = 0), 0 > r && (r *= -1), c.y1 += b - r[d], c.y2 += b - r[d], c.y3 += b - r[d], c.y4 += b - r[d], c.y5 && (c.y5 += b - r[d], c.y6 += b - r[d]), r[d] = b } }; a._animator.animate(0, c, function (c) {
                var d = a.plotArea.ctx || a.ctx; ha = !0; d.clearRect(z.x1, z.y1, z.x2 - z.x1,
                  z.y2 - z.y1); d.fillStyle = a.backgroundColor; d.fillRect(z.x1, z.y1, z.width, z.height); s.changeSection(c, b); var e = {}; e.dataSeries = t; e.dataPoint = t.reversed ? t.dataPoints[x.length - 1 - b] : t.dataPoints[b]; e.index = t.reversed ? x.length - 1 - b : b; a.toolTip.highlightObjects([e]); for (e = 0; e < O.length; e++)pa(d, O[e], t.fillOpacity); v(d); I && ("inside" !== t.indexLabelPlacement ? n(d) : f(), m(d)); 1 <= c && (ha = !1)
              }, null, L.easing.easeOutQuart)
            } function h() { for (var a = 0, b = 0; b < O.length - 1; b++)(0 <= Y.indexOf(b) || 0 <= Y.indexOf(b + 1)) && a++; return a }
            function n(a) { for (var b, c, d, e, f = 0; f < O.length; f++)e = 1 === H[f].lineThickness % 2 ? 0.5 : 0, c = ((O[f].y2 + O[f].y4) / 2 << 0) + e, b = g(c).x2 - 1, d = H[f].textBlock.x, e = (H[f].textBlock.y + H[f].height / 2 << 0) + e, H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor, a.lineWidth = H[f].lineThickness, a.setLineDash && a.setLineDash(N(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke()) } function r(a) { for (a -= 1; -1 <= a && -1 != a && H[a].isDirty; a--); return a } function q(a) {
              for (a += 1; a <= O.length &&
                a != O.length && H[a].isDirty; a++); return a
            } function g(a) { for (var b, c = 0; c < x.length; c++)if (O[c].y1 < a && O[c].y4 > a) { b = O[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1 } function m(a) { for (var b = 0; b < O.length; b++)H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) } function v(a) {
              y.plotArea.layoutManager.reset(); a.roundRect || Aa(a); y.title && (y.title.dockInsidePlotArea || "center" === y.title.horizontalAlign &&
              ...
              for (var t = this.data[a.dataSeriesIndexes[0]],
                x = t.dataPoints, z = this.plotArea, F = 0.025 * z.width, B = 0.01 * z.width, C = 0, D = z.height - 2 * F, E = Math.min(z.width - 2 * B, 2.8 * z.height), I = !1, R = 0; R < x.length; R++)if (!I && ("undefined" !== typeof x[R].indexLabel && null !== x[R].indexLabel && 0 < x[R].indexLabel.toString().length) && (I = !0), !I && ("undefined" !== typeof x[R].label && null !== x[R].label && 0 < x[R].label.toString().length) && (I = !0), !I && "function" === typeof t.indexLabelFormatter || "function" === typeof x[R].indexLabelFormatter) I = !0; I = I || "undefined" !== typeof t.indexLabel && null !== t.indexLabel &&
                  0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && I || (B = (z.width - 0.75 * E) / 2); var R = z.x1 + B, M = z.x2 - B, Z = z.y1 + F, Q = z.y2 - F, P = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    var ba, G; a = 75 * E / 100; var V = 30 * (M - a) / 100; "funnel" === t.type ? (ba = s(t.options.neckHeight) ? 0.35 * D : t.neckHeight, G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ?
                      (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0); var B = R + a / 2, W = R, $ = R + a, T = t.reversed ? Q : Z, K = B - G / 2, X = B + G / 2, wa = t.reversed ? Z + ba : Q - ba, ra = t.reversed ? Z : Q; a = []; var B = [], O = [], E = [], U = Z, ca, aa = (wa - T) / (K - W), ea = -aa, R = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d(); if (-1 !== R) {
                        if (t.reversed) for (E.push(U), G = R.length - 1; 0 < G; G--)U += R[G], E.push(U); else for (G = 0; G < R.length; G++)U += R[G], E.push(U); if (t.reversed) for (G =
                          0; G < R.length; G++)E[G] < wa ? (a.push(K), B.push(X), ca = G) : (a.push((E[G] - T + aa * W) / aa), B.push((E[G] - T + ea * $) / ea)); else for (G = 0; G < R.length; G++)E[G] < wa ? (a.push((E[G] - T + aa * W) / aa), B.push((E[G] - T + ea * $) / ea), ca = G) : (a.push(K), B.push(X)); for (G = 0; G < R.length - 1; G++)U = t.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length] : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length], G === ca ? O.push({
                            x1: a[G], y1: E[G], x2: B[G], y2: E[G], x3: X, y3: wa, x4: B[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1],
                            x6: K, y6: wa, id: G, height: E[G + 1] - E[G], color: U
                          }) : O.push({ x1: a[G], y1: E[G], x2: B[G], y2: E[G], x3: B[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: U }); var da = 2, H = [], ha = !1, Y = [], ga = [], R = !1; a = a = 0; Ba(Y); for (G = 0; G < x.length; G++)x[G].exploded && (R = !0, t.reversed ? Y.push(x.length - 1 - G) : Y.push(G)); P.clearRect(z.x1, z.y1, z.width, z.height); P.fillStyle = y.backgroundColor; P.fillRect(z.x1, z.y1, z.width, z.height); if (I && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
                            p(); for (G = 0; G < x.length; G++)H[G].isDirty ||
                              (a = H[G].textBlock.x + H[G].width, a = (M - a) / 2, 0 == G && (C = a), C > a && (C = a)); for (G = 0; G < O.length; G++)O[G].x1 += C, O[G].x2 += C, O[G].x3 += C, O[G].x4 += C, O[G].x5 && (O[G].x5 += C, O[G].x6 += C), H[G].textBlock.x += C
                          } for (G = 0; G < O.length; G++)C = O[G], pa(P, C, t.fillOpacity), ga.push(C.y1); v(P); I && t.visible && ("inside" === t.indexLabelPlacement || y.animationEnabled || n(P), y.animationEnabled || m()); if (!I) for (G = 0; G < x.length; G++)C = t.dataPointIds[G], a = {
                            id: C, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[t.reversed ? x.length -
                              1 - G : G]
                          }, y._eventManager.objectMap[C] = a; !y.animationEnabled && R ? k(y, -1, 0) : y.animationEnabled && !y.animatedRender && k(y, -1, 0); this.funnelPyramidClickHandler = function (a) { var b = -1; if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0; k(y, b, 500) } }; return {
                            source: P,
                            dest: this.plotArea.ctx, animationCallback: function (a, b) { L.fadeInAnimation(a, b); 1 <= a && (k(y, -1, 500), v(y.plotArea.ctx || y.ctx)) }, easingFunction: L.easing.easeInQuad, animationBase: 0
                          }
                      }
                  }
            }
            ...
            window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout; m.prototype.set = function (a, d, c) { c = "undefined" === typeof c ? !0 : c; "options" === a ? (this.options = d, c && this.render()) : m.base.set.call(this, a, d, c) }; m.prototype.exportChart = function (a) {
              ...
              var f = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= c.type.indexOf("stacked") ||
                "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                  var p = "#percent", l = "#total", k = this.getPercentAndTotal(c, d), l = isNaN(k.total) ? l : k.total, p = isNaN(k.percent) ? p : k.percent; do {
                    k = ""; if (c.percentFormatString) k = c.percentFormatString; else { var k = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / Math.abs(p)) / Math.LN10), 2); if (isNaN(h) || !isFinite(h)) h = 2; for (var n = 0; n < h; n++)k += "#"; c.percentFormatString = k } a = a.replace("#percent", ea(p, k, f._cultureInfo));
                    a = a.replace("#total", ea(l, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                  } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
              } return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                if ('"' === a[0] && '"' === a[a.length - 1] || "'" === a[0] && "'" === a[a.length - 1]) return a.slice(1, a.length - 1); a = Ea(a.slice(1, a.length - 1)); a = a.replace("#index", e); var h = null; try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/); g && 0 < g.length && (h = Ea(g[2]), a = Ea(g[1])) } catch (l) { } g = null; if ("color" === a) return "waterfall" ===
                  ...
                  } else return ea(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? ea(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" ===
            ...
            }; na(E, W); E.prototype.setLayout = function () {
              var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, p = 0, l = this.markerMargin = this.chart.options.legend && !s(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var k = [], h = []; "top" === this.verticalAlign ||
                "bottom" === this.verticalAlign ? (this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical", c = this.horizontalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height); this.errorMarkerColor = []; for (var n = 0; n < this.dataSeries.length; n++) {
                  ...
                  if (r.dataPoints && r.dataPoints.length) if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                  ...
                  r = null; m = g = z = x = 0; z = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f; u = 0 === u ? 0.75 * this.lineHeight : u; z -= u + l; for (n = 0; n < k.length; n++) {
                    q = k[n]; v = z; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) v -= 2 * 0.1 * this.lineHeight; if (!(0 >= p || "undefined" ===
                      typeof p || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                          q.textBlock = new ia(this.ctx, { x: 0, y: 0, maxWidth: v, maxHeight: this.itemWrap ? p : this.lineHeight, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }); q.textBlock.measureText(); null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" ===
                            q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!r || r.width + Math.round(q.textBlock.width + u + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) r = { items: [], width: 0 }, h.push(r), this.height += g, g = 0; g = Math.max(g, q.textBlock.height)
                        } else q.textBlock = new ia(this.ctx, {
                          x: 0, y: 0, maxWidth: z, maxHeight: !0 === this.itemWrap ? p : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily,
                          ...
                          0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); r.items.push(q); this.width = Math.max(r.width, this.width); m = q.textBlock.width + (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                  } this.itemWidth = m; this.height = !1 === this.itemWrap ? h.length * this.lineHeight : this.height + g; this.height = Math.min(p, this.height); this.width = Math.min(f, this.width)
              ...
              var a = this.bounds.x1, d = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, p = this.rows; (0 < this.borderThickness &&
                this.borderColor || this.backgroundColor) && this.ctx.roundRect(a, d, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); for (var l = 0, k = 0; k < p.length; k++) {
                  for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    var q = h.items[r], g = q.textBlock.x + a + (0 === r ? 0.2 * f : this.horizontalSpacing), m = d + l, s = g; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, d, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), s -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                      this.ctx.strokeStyle = this.errorMarkerColor[0]; this.ctx.lineWidth = f / 8; this.ctx.beginPath(); var u = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                        t = m + 0.15 * this.lineHeight, x = 0.7 * this.lineHeight, v = x + 0.02 * this.lineHeight; this.ctx.moveTo(u, t); this.ctx.lineTo(u + x, t); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(u + x / 2, t); this.ctx.lineTo(u + x / 2, t + v); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(u, t + v); this.ctx.lineTo(u + x, t + v); this.ctx.stroke(); this.errorMarkerColor.shift()
            ...
            }; na(I, W); I.prototype.getDefaultAxisPlacement = function () {
              ...
              if (!this.dataPoints || 0 === this.dataPoints.length) return null; var c = { dataPoint: null, distance: Infinity, index: NaN }, b = null, e = 0, f = 0, p = 1, l = Infinity, k = 0, h = 0, n = 0; "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ?
                (n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), n = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
                  f = 0 < p ? n + e : n - e; if (0 <= f && f < this.dataPoints.length) {
                    var b = this.dataPoints[f], r = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x :
                      Math.abs(b.x - a); r < c.distance && (c.dataPoint = b, c.distance = r, c.index = f); b = r; b <= l ? l = b : 0 < p ? k++ : h++; if (1E3 < k && 1E3 < h) break
              ...
              c = c || !1; var b = [], e = 0, f = 0, p = 1, l = !1, k = Infinity, h = 0, n = 0, r = 0; if ("none" !== this.chart.plotInfo.axisPlacement) if (r = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), r = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(r / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, r = 0 < q ? Math.min(Math.max((this.dataPoints.length -
                1) / q * (r - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; for (; ;) {
                  f = 0 < p ? r + e : r - e; if (0 <= f && f < this.dataPoints.length) {
                    var q = this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], m = null; if (q) {
                      switch (this.type) {
                        ...
                        }), l = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var s = la("markerSize", g, this) || 4, u = c ? 20 : s, m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); m <= u && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }); q = Math.abs(q.x1 - a); q <= k ? k = q : 0 < p ? h++ : n++; m <= s / 2 && (l = !0); break; case "rangeArea": case "rangeSplineArea": s = la("markerSize", g, this) ||
            ...
            }; na(D, W); D.prototype.createExtraLabelsForLog = function (a) {
              a = (a || 0) + 1; if (!(5 < a)) {
                var d = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                  for (var c = D.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length),
                    3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c)b < this.viewportMinimum || this.logLabelValues.push(b); this.logLabelValues.sort(Oa); this.createExtraLabelsForLog(a)
                }
              }
            }; D.prototype.createLabels = function () {
              var a, d, c = 0, b = 0, e, f = 0, p = 0, b = 0, b = this.interval, l = 0, k, h = 0.6 * this.chart.height, n; a = !1; var r = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = r.length ? s(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0; if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                e =
                this.viewportMaximum; if (this.labels) { a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c += a)if (this.labels[c]) g = !0; else { g = !1; break } g && (this.interval = a, this.intervalStartPosition = b) } if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)if (c = this.logLabelValues[b], c < this.viewportMinimum) b++; else {
                  for (; g < r.length && c > r[g].endValue; g++); a = g < r.length &&
                    c >= r[g].startValue && c <= r[g].endValue; n = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : ea(n, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                      x: 0, y: 0, maxWidth: f, maxHeight: p, angle: this.labelAngle, text: this.prefix + a + this.suffix, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, cornerRadius: this.labelCornerRadius, textAlign: this.labelTextAlign,
                  ...
                  this.interval) : c + this.interval).toFixed(12))) {
                    for (; g < r.length && c > r[g].endValue; g++); a = g < r.length && c >= r[g].startValue && c <= r[g].endValue; n = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : ea(n, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                      x: 0, y: 0, maxWidth: f, maxHeight: p, angle: this.labelAngle, text: this.prefix + a + this.suffix, textAlign: this.labelTextAlign,
        ...
        D.prototype.createLabelsAndCalculateWidth = function () {
          var a = 0, d = 0; this._labels = []; this._stripLineLabels = []; var c = this.chart.isNavigator ? 0 : 5; if ("left" === this._position || "right" === this._position) {
            this.createLabels(); if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index) for (d = 0; d < this._labels.length; d++) {
              var b = this._labels[d].textBlock, e = b.measureText(), f = 0, f = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin(Math.PI /
                180 * Math.abs(this.labelAngle)); a < f && (a = f); this._labels[d].effectiveWidth = f
          ...
          var a = 0; this._labels = []; this._stripLineLabels = []; var d, c = 0, b = this.chart.isNavigator ? 0 : 5; if ("bottom" === this._position || "top" === this._position) {
            this.createLabels(); if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index) for (c = 0; c < this._labels.length; c++) {
              d =
              this._labels[c].textBlock; var e = d.measureText(), f = 0, f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)); a < f && (a = f); this._labels[c].effectiveHeight = f
          ...
          var p, l, k, h, n = a[0] ? a[0].chart : d[0].chart, r = n.isNavigator ? 0 : 10, q = n._axes; if (a && 0 < a.length) for (var g = 0; g < a.length; g++)a[g] &&
            a[g].calculateAxisParameters(); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateAxisParameters(); if (c && 0 < c.length) for (g = 0; g < c.length; g++)c[g].calculateAxisParameters(); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g].calculateAxisParameters(); for (g = 0; g < q.length; g++)if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var m = q[g].scaleBreaks._appliedBreaks, u = 0; u < m.length && !(m[u].startValue > q[g].viewportMaximum); u++)m[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) &&
              (q[g].scaleBreaks.firstBreakIndex = u), m[u].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = u)); for (var v = u = 0, t = 0, x = 0, z = 0, y = 0, B = 0, C, D, E = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++)q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title, horizontalAlign: "center", fontSize: q[g].titleFontSize, fontFamily: q[g].titleFontFamily, fontWeight: q[g].titleFontWeight, fontColor: q[g].titleFontColor, fontStyle: q[g].titleFontStyle, borderColor: q[g].titleBorderColor, borderThickness: q[g].titleBorderThickness,
                backgroundColor: q[g].titleBackgroundColor, cornerRadius: q[g].titleCornerRadius, textBaseline: "top"
                ...
                case "left": q[g]._titleTextBlock.maxWidth = q[g].titleMaxWidth || f.height; q[g]._titleTextBlock.maxHeight = q[g].titleWrap ? 0.8 * f.width : 1.5 * q[g].titleFontSize; q[g]._titleTextBlock.angle = -90; break; case "right": q[g]._titleTextBlock.maxWidth = q[g].titleMaxWidth || f.height; q[g]._titleTextBlock.maxHeight = q[g].titleWrap ? 0.8 * f.width : 1.5 * q[g].titleFontSize;
                  q[g]._titleTextBlock.angle = 90; break; default: q[g]._titleTextBlock.maxWidth = q[g].titleMaxWidth || f.width, q[g]._titleTextBlock.maxHeight = q[g].titleWrap ? 0.8 * f.height : 1.5 * q[g].titleFontSize, q[g]._titleTextBlock.angle = 0
              }if ("normal" === e) {
                for (var x = [], z = [], y = [], B = [], M = [], N = [], P = [], Q = []; 4 > u;) {
                  var G = 0, V = 0, T = 0, W = 0, Y = e = 0, K = 0, $ = 0, U = 0, X = 0, O = 0, aa = 0; if (c && 0 < c.length) for (y = [], g = O = 0; g < c.length; g++)y.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += y[g], K += c[g] && !n.isNavigator ? c[g].margin : 0; else y.push(Math.ceil(c[0] ?
                                              ...
                                              (C = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, p = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, p = a[g].getApparentDifference(a[g].viewportMinimum, p), D = a[g].logarithmic ? (1 < p ? Math.log(p) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) +
                                                a[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                                                  p = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, p = d[g].getApparentDifference(d[g].viewportMinimum, p), D = d[g].logarithmic ? (1 < p ? Math.log(p) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 <
                                                    u) { if (a && 0 < a.length) for (g = 0; g < a.length; g++)m = M[u - 1][g] === M[u][g] ? !0 : !1; else m = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)I = N[u - 1][g] === N[u][g] ? !0 : !1; else I = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = P[u - 1][g] === P[u][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = Q[u - 1][g] === Q[u][g] ? !0 : !1; else L = !0 } if (m && I && J && L) break; u++
                ...
                r = []; C = []; E = []; v = []; D = []; t = []; M = []; for (N = []; 4 > u;) {
                  U = W = V = T = $ = K = Y = e = Q = P = G = X = 0; if (a && 0 < a.length) for (E = [], g = W = 0; g < a.length; g++)E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), W += E[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else E.push(Math.ceil(a[0] ?
                              ...
                              180 * Math.abs(h.textBlock.angle)), B = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))); if (n.panEnabled) for (g = 0; g < c.length; g++)r[g] = s(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = r[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++)n.sessionVariables.axisY.height = r[g]; if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--)l = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ?
                                c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = l - (r[g] + c[g].margin + X), c[g].lineCoordinates.y2 = l - (r[g] + c[g].margin + X), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + r[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = { x1: p, y1: l - (r[g] + X + c[g].margin), x2: k, y2: h - (X + c[g].margin), width: k - p, height: r[g] }, c[g].title && (c[g]._titleTextBlock.maxWidth =
                                  0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), X += r[g] + c[g].margin; if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--)b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (C[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = { x1: p, y1: l + (b[g].margin + G), x2: k, y2: h, width: k - p, height: V }, b[g].title && (b[g]._titleTextBlock.maxWidth =
                                    0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += C[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                                      ...
                                      K = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0; p = Math.round(f.x1 - e); l = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1) : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1; k = Math.round(f.x2 - U - Y); h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - T) : f.y2 > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2; if (c &&
                                        0 < c.length) for (K = 0; K < c.length; K++)c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p); if (b && 0 < b.length) for (K = 0; K < b.length; K++)b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, p = k - U); d[g].lineCoordinates = { x1: k + Q, y1: l, x2: k + Q, y2: h, height: Math.abs(h - l) }; "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" ===
                                          d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2); d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: l, x2: k + v[g] + Q, y2: h, width: k - p, height: h - l }; d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.height ? d[g].titleMaxWidth : d[g].lineCoordinates.height); d[g].calculateValueToPixelConversionParameters(); d[g].calculateBreaksSizeInValues(); Q += v[g] + d[g].margin
                                    } for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(),
                                      q[g].calculateBreaksSizeInValues()); if (0 < u) { if (a && 0 < a.length) for (g = 0; g < a.length; g++)m = M[u - 1][g] === M[u][g] ? !0 : !1; else m = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)I = N[u - 1][g] === N[u][g] ? !0 : !1; else I = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = D[u - 1][g] === D[u][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = t[u - 1][g] === t[u][g] ? !0 : !1; else L = !0 } if (m && I && J && L) break; u++
          ...
          var f = a[0] ? a[0].chart : d[0].chart; e = f.ctx; var k = f._axes; f.alignVerticalAxes && f.alignVerticalAxes(); e.save(); e.beginPath(); a[0] && e.rect(5,
          ...
          e.rect(f.x1, f.y1, Math.abs(f.x2 - f.x1), Math.abs(f.y2 - f.y1)); e.clip(); if (a && 0 < a.length) for (l = 0; l < k.length; l++)k[l].renderStripLinesOfThicknessType("value"); if (d && 0 < d.length) for (l = 0; l < d.length; l++)d[l].renderStripLinesOfThicknessType("value"); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].renderStripLinesOfThicknessType("value"); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].renderStripLinesOfThicknessType("value"); if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l].renderInterlacedColors(); if (d && 0 < d.length) for (l =
            0; l < d.length; l++)d[l].renderInterlacedColors(); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].renderInterlacedColors(); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].renderInterlacedColors(); e.restore(); if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l].renderGrid(), u && (a[l].createMask(), a[l].renderBreaksBackground()); if (d && 0 < d.length) for (l = 0; l < d.length; l++)d[l].renderGrid(), u && (d[l].createMask(), d[l].renderBreaksBackground()); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].renderGrid(), u && (c[l].createMask(),
              c[l].renderBreaksBackground()); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].renderGrid(), u && (b[l].createMask(), b[l].renderBreaksBackground()); if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l].renderAxisLine(); if (d && 0 < d.length) for (l = 0; l < d.length; l++)d[l].renderAxisLine(); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].renderAxisLine(); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].renderAxisLine(); if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l].renderStripLinesOfThicknessType("pixel"); if (d && 0 < d.length) for (l = 0; l <
                d.length; l++)d[l].renderStripLinesOfThicknessType("pixel"); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].renderStripLinesOfThicknessType("pixel"); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].renderStripLinesOfThicknessType("pixel")
          ...
          for (var a = 0; a < this.stripLines.length; a++)if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
            var d = Math.min(this.stripLines[a].startValue, this.stripLines[a].endValue), c = Math.max(this.stripLines[a].startValue,
              this.stripLines[a].endValue), d = this.getApparentDifference(d, c); this.stripLines[a].value = this.logarithmic ? this.stripLines[a].value * Math.sqrt(Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(d)) : this.stripLines[a].value + (Math.abs(this.stripLines[a].endValue - this.stripLines[a].startValue) - d) / 2; this.stripLines[a].thickness = d; this.stripLines[a]._thicknessType = "value"
          }
            ...
            if ("bottom" ===
              this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, l = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                  r = this._labels[h]; if (r.position < this.viewportMinimum) break; r.position > this.viewportMaximum || !(h === this._labels.length - 1 || k < Math.log(l / r.position) * m / e) || (c.push(r), l = r.position, k = r.textBlock.width * Math.abs(Math.cos(Math.PI /
                    180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                } this._labels = c
              } else { for (h = 0; h < this._labels.length; h++)r = this._labels[h], r.position < this.viewportMinimum || (k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k); c > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0) } if ("left" === this._position || "right" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var c =
                ...
                for (h = 0; h < this._labels.length; h++)r = this._labels[h], r.position <
                  this.viewportMinimum || (n = r.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += n); b > this.lineCoordinates.height * e && this.labelAutoFit && (d = !0)
              }
            ...
            for (h = 0; h < this._labels.length; h++)r = this._labels[h], r.position < this.viewportMinimum || r.position > this.viewportMaximum ||
              (q = this.getPixelCoordinatesOnAxis(r.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y + this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + r.textBlock.height -
                r.textBlock.fontSize / 2) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.fontSize / 2 + 5) : (q.x = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.x : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x - (0 > this.labelAngle ? r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(r.textBlock.width * Math.sin(Math.PI /
                  180 * this.labelAngle) + 5) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), r.textBlock.x = q.x, r.textBlock.y = q.y)); "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          ...
          }, this); else for (h = 0; h < this._labels.length; h++)r = this._labels[h], r.position < this.viewportMinimum || (r.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || r.textBlock.render(!0)
          ...
          if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var d = this, c, b = 0, e = 0, f = !1, k = !1, l = [], m = [], k = !1, b = 0; b < this.stripLines.length; b++) {
              var h = this.stripLines[b]; h._thicknessType === a && ("pixel" === a && (h.value < this.viewportMinimum ||
          ...
          if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
            var a = this.scaleBreaks._appliedBreaks; u ? (this.maskCanvas = sa(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas =
          ...
          var a =
            this.chart.ctx, d = u ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" === this._position || "top" === this._position) {
              if (this.lineThickness) {
                this.reversed ? (e = this.lineCoordinates.x2, f = this.lineCoordinates.x1) : (e = this.lineCoordinates.x1, f = this.lineCoordinates.x2); d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor ? this.lineColor : "black"; d.setLineDash && d.setLineDash(N(this.lineDashType, this.lineThickness));
              ...
              0, 0, this.chart.width, this.chart.height), d.clearRect(0, 0, this.chart.width, this.chart.height)); d.restore()
          ...
          if ("undefined" === typeof a) return null; var d = 0, c = 0, b, d = !0,
            e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x; if (this.logarithmic) {
              a = b = Math.pow(this.logarithmBase, (c - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit); if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
                if (!(e[c].endValue < this.conversionParameters.minimum)) if (d) if (e[c].startValue < this.conversionParameters.minimum) {
                  ...
                  b /= e[c].startValue / e[c - 1].endValue; if (b < e[c].size) { a *= Math.pow(e[c].endValue / e[c].startValue, 1 === e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) / b; break } else a *=
                    e[c].endValue / e[c].startValue / e[c].size; b /= e[c].size
                } else break
                ...
                if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) { a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)); break } else a *= e[c].startValue / this.conversionParameters.minimum * Math.pow(e[c].size,
                  Math.log(e[c].startValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)) * b, b *= Math.pow(e[c].size, Math.log(this.conversionParameters.minimum / e[c].startValue) / Math.log(e[c].endValue / e[c].startValue)); d = !1
              } else if (b < e[c].endValue / this.conversionParameters.minimum) {
                b /= e[c].endValue / this.conversionParameters.minimum; if (b > 1 / e[c].size) { a *= Math.pow(e[c].endValue / e[c].startValue, 1 >= e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) * b; break } else a /= e[c].endValue / e[c].startValue / e[c].size;
                b *= e[c].size; d = !1
              ...
              a = b = (c - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit; if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !==
                this.reversed) for (c = 0; c < e.length; c++) {
                  if (!(e[c].endValue < this.conversionParameters.minimum)) if (d) if (e[c].startValue < this.conversionParameters.minimum) {
                    if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size < e[c].endValue) { a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size; break } else a += e[c].endValue - this.conversionParameters.minimum - e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue), b -= e[c].size * (e[c].endValue -
                      this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue); d = !1
                  ...
                  e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), d = !1; else if (b < e[c].endValue - this.conversionParameters.minimum) { b -= e[c].endValue - this.conversionParameters.minimum; if (b > -1 * e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b; break } else a -= e[c].endValue - e[c].startValue - e[c].size; b += e[c].size; d = !1 } else break; else if (b < e[c].endValue - e[c + 1].startValue) {
                    ...
                    if (b > -1 * e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b; break } else a -= e[c].endValue - e[c].startValue - e[c].size; b += e[c].size
                  } else break; d = this.conversionParameters.minimum + a
          } return d
        }; D.prototype.convertValueToPixel = function (a) {
          a = this.getApparentDifference(this.conversionParameters.minimum, a, a); return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase +
          ...
          var e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : []; if (this.logarithmic) {
            c = s(c) ? d / a : c; for (var f = 0; f < e.length && !(d < e[f].startValue); f++)a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ?
          ...
          } else for (c = s(c) ? Math.abs(d - a) : c, f = 0; f < e.length &&
          ...
          d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d); this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, d) }; D.prototype.getXValueAt = function (a) { if (!a) return null; var d = null; "left" === this._position ? d = this.convertPixelToValue(a.y) : "bottom" === this._position && (d = this.convertPixelToValue(a.x)); return d }; D.prototype.calculateValueToPixelConversionParameters = function (a) {
            a = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : []; var d = {
              pixelPerUnit: null, minimum: null,
              reference: null
            ...
            d.range = b; if ("bottom" === this._position || "top" === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? -1 : 1) * c * d.lnLogarithmBase / Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(b), d.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1; if ("left" === this._position || "right" === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? 1 : -1) * c * d.lnLogarithmBase /
              Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? 1 : -1) * c / Math.abs(b), d.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2; this.conversionParameters = d
          }; D.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
              var a = this.chart.layoutManager.getFreeSpace(), d = !1, c = !1; "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width); var a = "axisX" ===
                this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40, b = 4; "axisX" === this.type && (b = 600 > this.maxWidth ? 8 : 6); var a = Math.max(b, Math.floor(this.maxWidth / a)), e, f, k, b = 0; !s(this.options.viewportMinimum) && (!s(this.options.viewportMaximum) && this.options.viewportMinimum >= this.options.viewportMaximum) && (this.viewportMinimum = this.viewportMaximum = null); if (s(this.options.viewportMinimum) && !s(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum =
                  this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum; if (s(this.options.viewportMaximum) && !s(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum; else if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum; if (this.scaleBreaks) for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)if ((!s(this.sessionVariables.newViewportMinimum) &&
                    this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[b].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[b].endValue ||
                      !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue)) { this.scaleBreaks._appliedBreaks.splice(b, 1); break } if ("axisX" === this.type) {
                        if (this.dataSeries && 0 < this.dataSeries.length) for (e = 0; e < this.dataSeries.length; e++)"dateTime" === this.dataSeries[e].xValueType && (c = !0); e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin; f = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax; 0 === f - e && (b = "undefined" === typeof this.options.interval ?
                          0.4 : this.options.interval, f += b, e -= b); Infinity !== this.dataInfo.minDiff ? k = this.dataInfo.minDiff : 1 < f - e ? k = 0.5 * Math.abs(f - e) : (k = 1, c && (d = !0))
                        ...
                        0 : Infinity), 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -= b)), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null ===
                          this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0)); b = this.getApparentDifference(isNaN(this.viewportMinimum) || null === this.viewportMinimum ? e : this.viewportMinimum, isNaN(this.viewportMaximum) || null === this.viewportMaximum ? f : this.viewportMaximum, null, !0); if ("axisX" === this.type && c) {
                            ...
                            this.intervalType = "number"; b = D.getNiceNumber(b, !1); this.interval =
                ...
                0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(f) ? 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -= b)) : (f = "undefined" === typeof this.options.interval ?
                  -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > f && (f = 0)), Math.abs(this.getApparentDifference(e, f, null, !0)), "axisX" === this.type && c) {
                    this.valueType = "dateTime"; if (null === this.minimum || isNaN(this.minimum)) this.minimum =
                      e - k / 2; if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + k / 2
                                    ...
                                    0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum)), 1 === this.maximum && 1 === this.minimum && (1 === this.options.minimum ? this.maximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this.options.maximum && (this.minimum /= this.logarithmBase - 1 / this.logarithmBase)); this.viewportMinimum = Math.max(this.viewportMinimum, this.minimum); this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum); this.viewportMinimum > this.viewportMaximum && (!this.options.viewportMinimum && !this.options.minimum ||
                                      this.options.viewportMaximum || this.options.maximum ? this.options.viewportMinimum || this.options.minimum || !this.options.viewportMaximum && !this.options.maximum || (this.viewportMinimum = this.minimum = (this.options.viewportMaximum || this.options.maximum) / Math.pow(this.logarithmBase, 2 * Math.ceil(this.interval))) : this.viewportMaximum = this.maximum = this.options.viewportMinimum || this.options.minimum); b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval); this.range =
                                        this.viewportMaximum / this.viewportMinimum; this.noTicks = a; if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (d = Math.floor(this.viewportMinimum / c + 0.5) * c; d < this.viewportMinimum;)d += c; this.equidistantInterval = !1; this.intervalStartPosition = d; this.interval = c } else this.options.interval || (c = Math.ceil(this.interval), this.range > this.interval && (this.interval = c, b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))),
                                          this.equidistantInterval = !0, this.intervalStartPosition = b; if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { d = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(d) || !isFinite(d)) d = 2; if (2 < d) for (k = 0; k < d - 2; k++)this.valueFormatString += "#" }
            ...
            d) { var c = Math.floor(Math.log(a) / Math.LN10), b = a / Math.pow(10, c), b = 0 > c ? 1 >= b ? 1 : 5 >= b ? 5 : 10 : Math.max(Math.floor(b), 1); return -20 > c ? Number(b * Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20)) }; D.getNiceNumber = function (a, d) { var c = Math.floor(Math.log(a) / Math.LN10), b = a / Math.pow(10, c), b = d ? 1.5 > b ? 1 : 3 > b ? 2 : 7 > b ? 5 : 10 : 1 >= b ? 1 : 2 >= b ? 2 : 5 >= b ? 5 : 10; return -20 > c ? Number(b * Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20)) }; D.prototype.getLabelStartPoint = function () {
              var a = Q[this.intervalType + "Duration"] * this.interval, a =
            ...
            }; na(T, W); na(U, W); U.prototype.createUserOptions = function (a) {
              if ("undefined" !==
                  ...
                  this.ctx, c = this.ctx.globalAlpha; this.ctx = a || this.ctx; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); var b = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue), e = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue); this.ctx.strokeStyle = this.lineColor; this.ctx.fillStyle = this.color; this.ctx.beginPath(); this.ctx.globalAlpha = 1; P(this.id); var f, k, l, m, h, n; a = Math.max(this.spacing,
                    3); var r = Math.max(0, this.lineThickness); this.ctx.lineWidth = r; this.ctx.setLineDash && this.ctx.setLineDash(N(this.lineDashType, r)); if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - r / 2, y1: e, x2: k + r / 2, y2: l }, this.ctx.moveTo(b,
                      e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e); else if ("wavy" === this.type) { m = b; h = e; f = 0.5; n = (l - h) / a / 3; for (var q = 0; q < n; q++)this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a), h += 3 * a, f *= -1; this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a); m = k; f *= -1; this.ctx.lineTo(m, h); for (q = 0; q < n; q++)this.ctx.bezierCurveTo(m + f * a, h - a, m + f * a, h - 2 * a, m, h - 3 * a), h -= 3 * a, f *= -1 } else {
                        if ("zigzag" ===
                          this.type) { f = -1; h = e + a; m = b + a; n = (l - h) / a / 2; for (q = 0; q < n; q++)this.ctx.lineTo(m, h), m += 2 * f * a, h += 2 * a, f *= -1; this.ctx.lineTo(m, h); m += k - b; for (q = 0; q < n + 1; q++)this.ctx.lineTo(m, h), m += 2 * f * a, h -= 2 * a, f *= -1; this.ctx.lineTo(m + f * a, h + a) }
                      } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position) if (e = 1 === r % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === r % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + r / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
                        k = this.chart.plotArea.x1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - r / 2, x2: k, y2: l + r / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(k, e), this.ctx.lineTo(k, l), this.ctx.lineTo(b, l); else if ("wavy" === this.type) {
                          m = b; h = e; f = 0.5; n = (k - m) / a / 3; for (q = 0; q < n; q++)this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h), m += 3 * a, f *= -1; this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h); h = l; f *= -1; this.ctx.lineTo(m,
                            h); for (q = 0; q < n; q++)this.ctx.bezierCurveTo(m - a, h + f * a, m - 2 * a, h + f * a, m - 3 * a, h), m -= 3 * a, f *= -1
            ...
            }; na(aa, W); aa.prototype.showAt = function (a) {
              if (!this.enabled) return !1; var d = this.chart, c = !1; d.resetOverlayedCanvas(); d.clearedOverlayedCanvas =
              ...
              e, f, k, l = null, m = null, h = null, n = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
                ...
                0.3 * this.chart.width : this.labelMaxWidth; this.labelMaxHeight = s(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize; 0 < r && q.setLineDash && q.setLineDash(N(this.lineDashType, r)); h = new ia(q, {
                  ...
                  var w = 0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var u = null; if ("bottom" === this.parent._position || "top" === this.parent._position) w = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d }); else if ("left" === this.parent._position || "right" === this.parent._position) w =
                        ...
                        t = 0, w = 0; w < n.length; w++)if (n[w].dataPoint.y && n[w].dataPoint.y.length) for (var x = 0; x < n[w].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])), t < u && (u = t, v = w); else t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y)), t < u && (u = t, v = w); else if ("stackedBar" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = t = 0, w = v = 0; w < n.length; w++)if (n[w].dataPoint.y && n[w].dataPoint.y.length) for (x = 0; x < n[w].dataPoint.y.length; x++)t =
                          Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])), t < u && (u = t, v = w); else z += n[w].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(z)), t < u && (u = t, v = w); else if ("stackedBar100" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = z = t = 0, w = 0; w < n.length; w++)if (n[w].dataPoint.y && n[w].dataPoint.y.length) for (x = 0; x < n[w].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])), t < u && (u = t, v = w); else z += n[w].dataPoint.y,
                            y = n[w].dataPoint.x.getTime ? n[w].dataPoint.x.getTime() : n[w].dataPoint.x, y = 100 * (z / n[w].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, v = w); else for (u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), w = v = t = 0; w < n.length; w++)if (n[w].dataPoint.y && n[w].dataPoint.y.length) for (x = 0; x < n[w].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])), t < u && (u = t, v = w); else t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y)),
                              t < u && (u = t, v = w); x = n[v]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                b = 0; if ("rangeBar" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type) {
                                  u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (w = t = 0; w < x.dataPoint.y.length; w++)t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[w])), t < u && (u = t, b = w); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0; h.text =
                                  ...
                                  u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (w = v; 0 <= w; w--)z += n[w].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(z)), t < u && (u = t, b = w); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) <<
                                  ...
                                  u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = z = t = 0; for (w = v; 0 <= w; w--)z += n[w].dataPoint.y, y = n[w].dataPoint.x.getTime ? n[w].dataPoint.x.getTime() :
                                    n[w].dataPoint.x, y = 100 * (z / n[w].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, b = w); l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y }) : s(this.options.label) ? ea(c ? c : y, this.valueFormatString, this.chart._cultureInfo) : this.label
                                ...
                                f = k = m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; b = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: b, y1: f - r / 2, x2: e, y2: k + r / 2 }; y = !1; if (this.parent.labels) for (n =
                    ...
                    this.bounds = { x1: b - r / 2, y1: f, x2: e + r / 2, y2: k }; y = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), w = 0; w < this.parent.viewportMaximum; w += n)if (this.parent.labels[w]) y = !0; else { y = !1; break } if (y) {
                      if ("axisX" === this.parent.type) for (w = this.parent.convertPixelToValue({ x: a }), u = null, v = 0; v < this.parent.dataSeries.length; v++)(u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) :
                    ...
                    0 < this.parent.dataSeries.length && (w = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a })); for (v = 0; v < this.parent.dataSeries.length; v++)(u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[v], null !== u.dataPoint.y && u.dataSeries.visible && n.push(u)); if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); v = 0; if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" ===
                      ...
                      u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (w = v; 0 <= w; w--)z += n[w].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(z)), t < u && (u = t, b = w); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) <<
                      ...
                      u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (w = v; 0 <= w; w--)z += n[w].dataPoint.y, y = n[w].dataPoint.x.getTime ?
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds =
                    { x1: b - r / 2, y1: f, x2: e + r / 2, y2: k }; else if ("left" === this.parent._position || "right" === this.parent._position) f = k = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - r / 2, x2: e, y2: k + r / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                      y = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), w = 0; w < this.parent.viewportMaximum; w += n)if (this.parent.labels[w]) y = !0; else { y = !1; break } if (y) {
                        if ("axisX" ===
                      ...
                      y = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), w = 0; w < this.parent.viewportMaximum; w += n)if (this.parent.labels[w]) y = !0; else { y = !1; break } if (y) {
                        if ("axisX" === this.parent.type) for (w = this.parent.convertPixelToValue({ x: a }), u = null, v = 0; v < this.parent.dataSeries.length; v++)(u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ?
            ...
            }; na($, W); $.prototype._initialize = function () {
              ...
              c = "undefined" === typeof c ? !0 : c; this.container || this._initialize(); this.enabled || (this.hide(), this.dispatchEvent("hidden", { chart: this.chart, toolTip: this }, this)); if (!this.chart.disableToolTip) {
                if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY =
                  d; var b = null, e = null, f = [], k = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index; else if (u) if (h = Xa(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
        ...
        $.prototype.highlightObjects = function (a) {
          ...
          if ("mousemove" === a.type || "click" === a.type) {
            var d = [], c = Ma(a), b = null; if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
      ...
      }(); y.version = "v3.2 GA"; window.CanvasJS && (y && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = y)
})();
